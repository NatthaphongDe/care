                  ...
                  <div class="row row_email_proc row_proc">
                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="form-group col-lg-7">
                        ...
                        <input type="text" class="form-control procPropEmail_subject" name="procPropEmail_subject_2[]" value="<?php echo ($rs_case["case"]['applnt_country_id'] == 162)?  'แจ้งผู้ร้องเรียนว่าได้รีบเรื่องร้องเรียนแล้ว':'Inform the complainant that the complaint has been received.' ?>"  />
                      </div>
                      <div class="col-md-1 hidden-xs hidden-sm hidden-md ">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      ...
                      <div class="form-group col-lg-7">
                      <input type="hidden" class="form-control country_id" name="country_id" value="<?php echo $rs_case["case"]['applnt_country_id'] ?>"/>
                        ...
                        <?php if ($rs_case["case"]['applnt_country_id'] == 162) { ?>
                          <div class="content" style="width:auto; height:auto; padding:20px; font-family: Tahoma, Verdana, Segoe, sans-serif; font-size:16px;">
                            เรียน คุณ <?php echo $rs_case['case_feild']['applnt_firstname']."  ".$rs_case['case_feild']['applnt_lastname']; ?> <br /> <br />
                            &nbsp;&nbsp; ตามที่ท่านได้ยื่นเรื่องร้องเรียนในระบบบริการตรวจสอบคู่ค้าเบื้องต้น และ ให้คำปรึกษาด้านข้อพิพาททางการค้าระหว่างประเทศ DITP CARE หมายเลขเคส (<?php echo $rs_case["case"]["case_id"] ?>) นั้น <br /> <br />
                            ทีม DITP Care ได้รับเรื่องของท่านเรียบร้อยแล้ว ทั้งนี้ ท่านสามารถติดตามความคืบหน้าได้จากระบบ <!-- <a href="http:// <?php echo $_SERVER["HTTP_HOST"]  ?>/frontend/index.php?page=appeal_detail&case_id=<?php echo $rs_case["case"]["case_id"] ?>&user_id=<?php echo $rs_case["case"]["case_createBy_id"] ?>" target="blank"> DITP Care</a> -->DITP Care  <!--  หรือ ติดต่อหมายเลข 02-507-8247 ตามวันและเวลาราชการ --> <br />
                          </div>
                        <?php }else{ ?>
                          <div class="content" style="width:auto; height:auto; padding:20px; font-family: Tahoma, Verdana, Segoe, sans-serif; font-size:16px;">
                            Dear (<?php echo $rs_case['case_feild']['applnt_firstname']."  ".$rs_case['case_feild']['applnt_lastname']; ?>) <br /> <br />
                            &nbsp;&nbsp; Your case has been successfully submitted to the Trading Partner Verification and International Trade Dispute Consultation Service (DITP Care) under case number (<?php echo $rs_case["case"]["case_id"] ?>).<br /> <br />
                            You can follow up on the progress through the DITP Care System.<br />
                          </div>
                        <?php } ?>
