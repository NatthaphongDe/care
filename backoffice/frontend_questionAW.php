...
<span class="txt_hr_report">รายงานแบบสอบถามของผู้ประกอบการ ( Web )</span>

  <div class="row">
    <div class="col-md-12" style="padding-right:0px;">
      <div class="panel panel-default panel-report">
      <div class="panel-body">
          <div class="hr_report" style="display:inline-block;">รายการแบบสอบถามของผู้ประกอบการ ( Web )</div>
          <div class="row">
          ...
          <div style="margin-top:30px;">
            <div class="tabla_data">
              ...
              data-url="question_function/frontend_function.php?method=frontend_function"
              ...
              data-method="post">
                  <thead>
                    ...
                    <th data-field="case_id" data-sortable="true" data-align="left" data-width="40%">
                      เลขที่เคส
                    </th>
                    <th data-field="name" data-sortable="true" data-align="left">
                      ชื่อ - นามสกุล
                    </th>
                    <th data-field="com_name" data-sortable="true" data-align="left">
                      ชื่อบริษัท
                    </th>
                    <th data-field="email" data-sortable="false" data-align="left">
                      E-mail
                    </th>
  ...
  <form method="post" action="#" id="modal_questionAW" enctype="multipart/form-data">
  		<div class="modal fade" id="modal_chk_questionAW" tabindex="-1" role="dialog" aria-labelledby="modal_chk_questionAW" style="padding:0px;">
            ...
            <table class="table table-bordered table_aws">
            <thead>
              <tr>
                <th>ลำดับ</th>
                <th>คำถาม</th>
