          ...
          <div class="col-xs-12 col-sm-4 col-lg-3 no-gutter">
            <div class="dropdown dropdown-search-valid search-valid-ditp " style="float: right;">
              <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                <img class="btn_search_valid btn_search_ditp" src="img/logo_ditp/btn_search_ditp.png" />
              </button>
            ...
            <div class="btn_search_valid btn_search_dbd">
              
            </div>
           
            <input type="hidden" name="search_valid_dbd" value="" />
             <img src="img/button Frame 49.svg" class="search-valid-ditp" onclick="toggleInfoBox()" style="cursor: pointer; max-height: 34px; float: right;" alt="info" />
            <div class="" id="memberInfoBox" style="display: none; position: absolute; top: 45px; left: 0px; background-color: white; padding: 16px; width: 350px; border-radius: 12px; box-shadow: 0 0 10px rgba(0,0,0,0.15); z-index: 10;">
              <h4 style="margin-bottom: 10px;"><strong>สัญลักษณ์ของสถานะ</strong></h4>

              <!-- DBD-->
              <div class="status-row" style="display: flex; align-items: center; margin-bottom: 10px;">
                <img src="img/icon_dbd_r100_1.png" alt="Non Member" style="height: 24px; margin-right: 10px;" />
                <div>นิติบุคคลตาม DBD</div>
              </div>
              <!-- No DBD -->
              <div class="status-row" style="display: flex; align-items: center; margin-bottom: 10px;">
                <img src="img/icon_dbd_r100_02.png" alt="Non Member" style="height: 24px; margin-right: 10px;" />
                <div>ไม่เป็นนิติบุคคลตาม DBD</div>
              </div>
              <!-- ไม่พบข้อมูล -->
              <div class="status-row" style="display: flex; align-items: center; margin-bottom: 10px;">
                <img src="img/logo_ditp/ico-ditp-2.png" alt="Non Member" style="height: 24px; margin-right: 10px;" />
                <div>ไม่เคยร่วมกิจกรรม</div>
              </div>

              <!-- ไม่พบข้อมูล -->
              <div class="status-row" style="display: flex; align-items: center; margin-bottom: 10px;">
                <img src="img/button Group 10.svg" alt="Check" style="height: 24px; margin-right: 10px;" />
                <div>ไม่เป็นสมาชิกกรม (เคยร่วมกิจกรรมกรม)</div>
              </div>

              <h4 style="margin-bottom: 10px;"><strong >สมาชิกกรม</strong></h4>
              <img src="img/ico-ditp-el.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
              <img src="img/ico-ditp-pre-el.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
              <img src="img/ico-ditp-tdc.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
              <img src="img/ico-ditp-pre-tdc.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
              <img src="img/ico-ditp-smex.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
              <img src="img/ico-ditp-pre-smex.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
              <img src="img/ico-ditp-sel.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
              <img src="img/ico-ditp-spl.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
              <img src="img/ico-ditp-lsps.svg" alt="Non Member" style="height: 24px; margin-right: 10px; margin-bottom: 8px;" /><br>
            </div>
          </div>
        </div>
      </div>
...
$(function() {
  ...
  $('.daterange').daterangepicker({
    ...
    $('.search-valid-ditp .dropdown-menu li a').click(function(){
      ...
      if($(this).parent("li").hasClass("search_ditp_active")){
        $('.search-valid-ditp button .btn_search_ditp').attr("src","img/logo_ditp/btn_search_ditp_active.png");
        $('input[name="search_valid_ditp"]').val($(this).attr("rel"));
      }else{
        $('.search-valid-ditp button .btn_search_ditp').attr("src","img/logo_ditp/btn_search_ditp.png");
  ...
  // ปิดกล่องเมื่อคลิกรอบนอก
  window.addEventListener('click', function(e) {
    const box = document.getElementById('memberInfoBox');
    const trigger = document.querySelector('img[onclick="toggleInfoBox()"]');
