...
$toyear = date("Y");
?>
<div class="row   db_lbl_title" style="">
    
    <div class="col-md-3 col-sm-9 col-xs-4  no-margin-padding pd_10">
...
<div class="col-md-12 col-lg-12">
  <div class="bg_db">
    <div class="db_lbl_title"   style="padding-top:10px; padding-bottom:10px;">
      <lable class="title_case">Category</lable>
      <div class="float_right cate_flex">
        <button class="btn btn-success print_cat" id="printCat2PDF" onclick="print_cat();">พิมพ์</button>
        <lable class="by_year">
          ปีปฏิทิน <?=$y_set; ?>
        </lable>
        <i class="fa fa-ellipsis-v adv_se nav_cat" aria-hidden="true" onclick="filter_case(2);" style=""></i>
                  ...
                  <div class="col-md-5">
                    <div class="div_be issue_year_cat1">
                      <select class="selectpicker form-control" name="issue_year_th_cat" id="issue_year_cat1" onchange="select_month_cat();">
                        ...
                        for($year = $date_year; $year>=$date_year-5; $year--){
                          $year_sum = $year+543;
                          ?>
                          ...
                          <?php
                            ...
                            // ถ้าเดือนปัจจุบันมากกว่า 10 ให้บวกเพิ่ม 1 ปี
                            $date_year = ($current_month >= 10) ? $date_year + 1 : $date_year ;
...
<div class="col-md-12 col-lg-12">
  <div class="pd_all_mar">

    <div class="bg_db">
      <div class="row   db_lbl_title">
        <div class="col-md-3 col-sm-9 col-xs-4  no-margin-padding pd_10">
          <lable class="title_case">Case Status</lable>
        </div>
        <div class="col-md-9 box_s1 box_db none_select nav_case">
          <select name="month_case" id="month_case" class="selectpicker_v" data-width="150px" onchange="ch_val();">
                          ...
                          <div class="row form-group gp_month box_monthly">
                            ...
                            <div class="col-md-5">
                              <div class="months_issue1">
                                <select class="selectpicker form-control" name="month_issue_case_th" id="month_issue_1" onchange="select_month_issue();">
                                  <option value="">- เลือกเดือน -</option>
                                  <?php
                                  $months = array(
                                    "01"=>'มกราคม',
                                ...
                                <div class="months_issue2">
                                  <select class="selectpicker form-control" name="month_issue_case_en" id="month_issue_2" onchange="select_month_issue();">
                                    <option value="">- เลือกเดือน -</option>
                                    <?php
                                    $months = array(
                                     "01"=>'มกราคม',
                                ...
                                <div class="col-md-5">
                                  <div class="input-group st_date">
                                    <div class="input-group date" id="datetimepicker_case_1" onchange="set_date_select()">
                                      ...
                                      <input type="text" class="form-control input-mask" data-inputmask="'mask':'99/99/9999'" name="date_start_case" id="startDate" />
                                ...
                                <div class="col-md-5">
                                  <div class="input-group sp_date">
                                    <div class="input-group date" id="datetimepicker_case_2">
                                      <input type="text" class="form-control input-mask" data-inputmask="'mask':'99/99/9999'" name="date_stop_case" id="stopDate" />
                                      <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar color_green"></span>
                                      </span>
                                    </div>
            ...
            <div class="">
              <div class="bg_db pd_all_mar">
                <div class="row db_lbl_title">
                  <div class="col-md-3  col-sm-9  col-xs-4  no-margin-padding pd_10 filter_activity">
                    <select name="filter_activity" id="filter_activity" class="selectpicker" data-width="200" onchange="ch_activity();">
                      ...
                      <option value="30">ยุติข้อร้องเรียน</option>
                    </select>
                  </div>
                  <div class="col-md-9 box_s1 box_db none_select nav_all_a" style="">
...
<div class="col-md-12 box_all_kpi">
  <div class="bg_db">
    <div class="row db_lbl_title">
      <div class="col-md-6  col-sm-9 col-xs-4   no-margin-padding pd_10 filter_activity">
        <lable class="title_case">Key Performance Indicator (KPIs)</lable>

      </div>
      <div class="col-md-6 box_s1 box_db none_select" style="text-align: right;position: relative;margin-top: 12px;">
      ...
      <input type="hidden" name="type_search_all" id="type_search_all" value="0">
...
$('.table-caseCh-list').on('load-success.bs.table', function (e, name, args) {
  ...
  $("button[name='submit_case_all']").on('click', function() {

    $('#type_search_all').val('1');
    
    var display_case_all = $('input[name=display_case_all]:checked').val();
    if(display_case_all==1){
      var year_all =  $("select[name='issue_year_th_all']").val();
      var month_txt_all =  $("select[name='month_issue_th_all']").val();
      
    }else{
      var year_all =  $("select[name='issue_year_en_all']").val();
      var month_txt_all =  $("select[name='month_issue_en_all']").val();
      
    }
    var year_type_case_all = $('input[name=year_type_case_all]:checked').val();
    var date_start_all =  $("input[name='date_start_all']").val();
    var date_stop_all =  $("input[name='date_stop_all']").val();

    $('#month_issue_1').val($("select[name='month_issue_th_all']").val());
    $('#month_issue_2').val($("select[name='month_issue_en_all']").val());
    $('#son_active').val(2);
    $('input[name=year_type_case]:checked').val(year_type_case_all);
    $('#month_case').val($('#month_case_all').val());
    $('#year_case').val(year_all);
    $('#issue_year1').val($("select[name='issue_year_th_all']").val());
    $('#issue_year2').val($("select[name='issue_year_en_all']").val());
    $('#select_quarter_chk').val($("input[name='quarter_all']").val());
    ...
    if(year_type_case_all == 1){
      if(date_start_all =='' && year_all ==''  ){
          alert('กรุณาเลือกช่วงเวลา หรือ กำหนดเอง Start Date ');
      }else if(date_start_all !=''){
        if(date_stop_all ==''){
            alert('กรุณาเลือกวันที่ Stop Date ');
        }else{
          // console.log(2);
          $(".by_case_all").html("<span>วันที่ "+date_start_all+" - "+date_stop_all+"</span>");

          $('#secrch_case_all').val(1);

          data_case_filter()
          // var data = {
          //     id_case: $('#input_case').val(),
          //     month_case: month_txt_all,
          //     year_case: year_all,
          //     issue_year: year_all,
          //     select_quarter_chk: $("input[name='quarter_all']").val(),
          //     month_issue: month_txt_all,
          //     secrch_case: $('#secrch_case_all').val(),
          //     startDate: date_start_all,
          //     stopDate: date_stop_all,
          //     chechk_type_year: $('input[name=year_type_case_all]:checked').val(),
          //     year_type_case: year_type_case_all
          // };
          // $.ajax({
...
// ------------------------------
        ...
        var select_quarter_chk_all =  $('#select_quarter_chk_all').val();
        if(display_case_all==1){
          var  thmonth_all = new Array (  "มกราคม","กุมภาพันธ์","มีนาคม", "เมษายน",
                                      "พฤษภาคม","มิถุนายน", "กรกฎาคม","สิงหาคม",
                                      "กันยายน","ตุลาคม","พฤศจิกายน","ธันวาคม");
          year_all = parseInt(year_all) + 543;
          if(month_txt_all!=''){
            $(".by_case_all").html("<span>"+thmonth_all[month_txt_all-1]+" ปี "+year_all+" (ปีปฏิทิน)</span>");
          }else if(select_quarter_chk_all!=''){
            $(".by_case_all").html("<span>ไตรมาสที่ "+select_quarter_chk_all+" ปี "+year_all+" (ปีปฏิทิน)</span>");
          }else{
            $(".by_case_all").html("<span>ปี "+year_all+" (ปีปฏิทิน)</span>");
          }
        }else{
          if(month_txt_all!=''){
            var  thmonth_all = new Array (  "January","February","February", "April",
                                        "May","June", "July","August",
                                        "September","October","October","October");
            year_all = parseInt(year_all);
            $(".by_case_all").html("<span>"+thmonth_all[month_txt_all-1]+" year "+year_all+" (ปีปฏิทิน)</span>");
          }else if(select_quarter_chk_all!=''){

            $(".by_case_all").html("<span>ไตรมาสที "+select_quarter_chk_all+" ปี "+year_all+" (ปีปฏิทิน)</span>");
          }else{
            $(".by_case_all").html("<span>ปี "+year_all+" (ปีปฏิทิน)</span>");
          }
        }
      ...
      if(year_all==''){
        ...
        $(".by_case_all").html("<span>ปี "+year_all+" (ปีงบประมาณ)</span>");
        $('#secrch_case_all').val(1);
  ...
  $("button[name='submit_case']").on('click', function() {
    ...
    if(display_case==1){
      ...
      var month_txt =  $("select[name='month_issue_case_th']").val();
    }else{
      var year =  $("select[name='issue_year_en']").val();
      var month_txt =  $("select[name='month_issue_case_en']").val();
    }
    var year_type_case = $('input[name=year_type_case]:checked').val();
    var date_start =  $("input[name='date_start_case']").val();
    var date_stop =  $("input[name='date_stop_case']").val();
    if(year_type_case == 1){
      if(date_start =='' && year ==''  ){
          alert('กรุณาเลือกช่วงเวลา หรือ กำหนดเอง Start Date ');
      }else if(date_start !=''){
...
function searchQueryParams_case(params) {
  // console.log($('#type_search_all').val()+' ss');
  if($('#type_search_all').val() == '0'){
     // เช็คปี
    ...
    console.log('input_case ' + params.input_case);
    return params;
  } else{
     // เช็คปี
    var issue_year_th = $("select[name='issue_year_th_all']").val();
    var issue_year_en = $("select[name='issue_year_en_all']").val();
    if(issue_year_th!=''){
      params.chechk_type_year = 1;
      params.year_adv = $("select[name='issue_year_th_all']").val();
    }else if(issue_year_en!=''){

      params.year_adv = $("select[name='issue_year_en_all']").val();
    }
    // ไตรมาส
    params.quarter = $("select[name='quarter_all']").val();

    // เข็ครายเดือน
    var month_issue_th = $("select[name='month_issue_th_all']").val();
    var month_issue_en = $("select[name='month_issue_en_all']").val();
    if(month_issue_th!=''){
      params.month_adv = $("select[name='month_issue_th_all']").val();
    }else if(month_issue_en!=''){
      params.month_adv = $("select[name='month_issue_en_all']").val();
    }

    // วันที่เริ่มต้น
    params.date_start = $("input[name='date_start_all']").val();
    params.date_stop = $("input[name='date_stop_all']").val();
    params.input_case = $("input[name='input_case']").val();
    params.secrch_case = $("input[name='secrch_case_all']").val();
    params.display_case = $('input[name=display_case_all]:checked').val();
    params.month_case = $("select[name='month_case_all']").val();
    params.year_case = $("select[name='year_case_all']").val();
    params.filter_activity = $("select[name='filter_activity']").val();
    params.text = $("input[name='search_text']").val();
    console.log('input_case ' + params.input_case);
    return params;
...
function searchQueryParams_activity(params) {
  if($('#type_search_all').val() == '0'){
    ...
    params.year_type_activity= $('input[name=year_type_case_all]:checked').val();

    params.display_activity= $('input[name=display_case_all]:checked').val();
    if(params.display_activity==1){
      params.year = $('#issue_year1_all').val();
      params.month = $('#month_issue_1_all').val();

    }else{
      params.year = $('#issue_year2_all').val();
      params.month = $('#month_issue_2_all').val();
    }
    params.select_quarter_chk_activity =  $('#select_quarter_chk_all').val();
    params.search_activity = $("#search_activity").val();
    params.startDate_activity = $("#startDate_all").val();
    params.stopDate_activity = $("#stopDate_all").val();
