function data_category_all() {
    var display_cat = $('input[name=display_case_all]:checked').val();
    var year_type_cat = $('input[name=year_type_case_all]:checked').val();
    if (display_cat == 1) {
        var issue_year = $('#issue_year1_all').val();
        var month = $('#month_issue_1_all').val();
    } else {
        issue_year = $('#issue_year2_all').val();
        var month = $('#month_issue_2_all').val();
    }
    var data = {
        display_cat: display_cat,
        year_type_cat: year_type_cat,
        issue_year: issue_year,
        select_quarter_chk_cat: $('#select_quarter_chk_all').val(),
        month: month,
        startDate_cat: $('#startDate_all').val(),
        stopDate_cat: $('#stopDate_all').val(),
...
function print_cat() {
    ...
    // console.log(year_type_cat);

    var url = 'dashboard/print_category.php?display_cat=' + display_cat + '&year_type_cat=' + year_type_cat + '&issue_year=' + issue_year + '&select_quarter_chk_cat=' + $('#select_quarter_chk_cat').val() + '&month=' + month + '&startDate_cat=' + $('#startDate_cat').val() + '&stopDate_cat=' + $('#stopDate_cat').val() + '&search_cat=' + $('#search_cat').val() + '';
    console.log(url);
    url = encodeURI(url);
    window.open(url);

    // $.post("dashboard/print_category.php", data);
    // window.open("dashboard/print_category.php");
}
...
function data_kpi_all() {

    var display_kpi = $('input[name=display_case_all]:checked').val();
    var year_type_kpi = $('input[name=year_type_case_all]:checked').val();
    if (display_kpi == 1) {
        var issue_year = $('#issue_year1_all').val();
        var month = $('#month_issue_1_all').val();
    } else {
    ...
    var data = {
        year_kpi: $('#year_case_all').val(),
        month_kpi: $('#month_case_all').val(),
        display_kpi: display_kpi,
        year_type_kpi: year_type_kpi,
        issue_year: issue_year,
        select_quarter_chk_kpi: $('#select_quarter_chk_all').val(),
        month: month,
        startDate_kpi: $('#startDate_all').val(),
        stopDate_kpi: $('#stopDate_all').val(),
