  ...
  if ($this->compTypeSub1 === '1') {
    $formSet_html .= '
        <div class="col-sm-6 flex_wrap" id="div_type1_complnt_trade_number_10">
          ...
          <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'ditp\',\'#complnt_trade_number_IdxFs_'.$formSetId.'\',\'complnt\');"><img class="check_ditp_logo" id="check_ditp_logo_IdxFs_'.$formSetId.'" src="'.($rs_case["case_feild"]["complnt_valid_ditp"]!=""?($rs_case["case_feild"]["complnt_valid_ditp"]=="1"?"img/logo_ditp/btn-ditp-".$rs_case["case_feild"]["complnt_valid_ditp_org"]:"img/logo_ditp/btn_check_ditp_".$rs_case["case_feild"]["complnt_valid_ditp"]):"img/logo_ditp/btn_check_ditp_0").'.png" /></button>
