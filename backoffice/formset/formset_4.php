...
if($typeformset=="case_open"){
  $formSet_html = '<div class="panel-body">
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-6 div_complnt_trade_number" id="div_complnt_trade_number_4">
        </div>
      </div>
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-4" id="div_complnt_name_4">
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-6 div_complnt_contact_name" id="div_complnt_contact_name_4">
        </div>
        ...
        <div class="col-sm-4 flex-container div_complnt_contact_tel">
          <div class="flex2" id="tel3"> 
            <input type="text" value="'.$rs_case["case_feild"]["complnt_contact_tel"].'" data-code="'.$rs_case["case_feild"]["complnt_contact_tel"].'" class="form-control tel_format input-mask phone-number-complnt" name="complnt_contact_tel_IdxFs_'.$formSetId.'" />
        ...
        <div class="div_col-sm-1 div_complnt_contact_tel" id="div_complnt_contact_tel_4">
        </div> -->
      </div>
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-6 div_complnt_contact_tel" id="div_complnt_contact_tel_4">
        </div>
      </div>
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-6 div_complnt_contact_email" id="div_complnt_contact_email_4">
        </div>
  ...
  $formSet_html = '<div class="panel-body">
    ...
    <div id="collapse2" class="collapse in '.$enebledRef.'"  aria-labelledby="headingOne">
      ...
      <div class="form-group col-sm-10">
        ...
        './*($rs_case["case_feild"]["complnt_backlist"]!=""?'<img class="ico_validate" src="img/icon_backlist_'.$rs_case["case_feild"]["complnt_backlist"].'.png" />':'')*/''.'
        '.$icon_cn.'
        </div>
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-8">
          <label class="text-data text-data-green">'.($rs_case["case_feild"]["complnt_contact_tel"]!=""?($rs_case["case_feild"]["complnt_mobile_code"].substr($rs_case["case_feild"]["complnt_contact_tel"],1)):"-").'</label>
          '.$icon_at.'
          </div>
      </div>
