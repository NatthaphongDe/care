...
if($typeformset=="case_open"){
  $formSet_html = '<div class="panel-body">
    ...
    <div class="form-group col-md-12">
      ...
      <div class="col-sm-4">
      <div id="tel1">
        <input type="number" value="'.$rs_case["case_feild"]["applnt_mobile"].'" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control input-mask phone-number" name="applnt_mobile_IdxFs_'.$formSetId.'" data-inputmask="&apos;mask&apos;:&apos;999-999-9999&apos;"  />
    ...
    <div class="col-md-12 panel-body-bg2 no-gutter">
      ...
      <div class="form-group-inner no-gutter " id="form_group_company_'.$formSetId.'" '.($rs_case["case"]["applnt_type"]==0?'style="display:none"':'').'>
        ...
        <div class="form-group col-md-12">
          ...
          <div class="col-sm-6">
            <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'dbd\',\'#applntOrg_trade_number_IdxFs_'.$formSetId.'\');"><img id="check_dbd_logo_IdxFs_'.$formSetId.'" src="img/new_logo_dbd/btn_check_dbd_'.($rs_case["case_feild"]["applnt_valid_dbd"]!=""?$rs_case["case_feild"]["applnt_valid_dbd"]:"0").'.png" /></button>
            <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'ditp\',\'#applntOrg_trade_number_IdxFs_'.$formSetId.'\');"><img id="check_ditp_logo_IdxFs_'.$formSetId.'" src="img/logo_ditp/btn_check_ditp_'.($rs_case["case_feild"]["applnt_valid_ditp"]!=""?$rs_case["case_feild"]["applnt_valid_ditp"]:"0").'.png" /></button>
