...
if($typeformset=="case_open"){
  ...
  // else {
    ...
    <div class="form-group col-md-12">
      ...
      <div class="col-sm-6 applnt_ident" id="div_applnt_ident_9">
      </div>
    </div>
    <div class="form-group col-md-12">
      <label class="col-sm-2 control-label ">คำนำหน้าชื่อ</label>
  ...
  // else if (in_array($_SESSION['admin']['empId'], array('1', '7'))) {
    ...
    <div class="form-group col-md-12">
      ...
      <div class="col-sm-6 applnt_email" id="div_applnt_email_9">
      </div>
    </div>
    <div class="form-group col-md-12">
      ...
      <div class="col-sm-6 applnt_mobile" id="div_applnt_mobile_9">
      </div>
    </div>';
  // }
  ...
  $formSet_html .= '
          <div class="col-sm-6 applntOrg_trade_number" id="div_applntOrg_trade_number_9">
  ...
  $formSet_html .= '
        ...
        <div class="form-group col-md-12">
          ...
          <div class="col-sm-6">
           ...
           <div class="col-sm-4 applntOrg_name" id="div_applntOrg_name_9">
          </div>
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
          ...
          <div class="col-sm-6 applntOrg_tel" id="div_applntOrg_tel_9">
          </div>
        </div>
        <div class="form-group col-md-12">
