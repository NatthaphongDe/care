...
if($typeformset=="case_open"){
  $formSet_html = '<div class="panel-body">
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-4">
          <input type="text" value="'.$rs_case["case_feild"]["complnt_trade_number"].'" class="form-control complnt_trade_number" name="complnt_trade_number_IdxFs_'.$formSetId.'" id="complnt_trade_number_IdxFs_'.$formSetId.'"  />
        </div>
        <input id="typesub" value="'.$this->compTypeSub1.'" hidden>
        <div class="col-sm-6 flex_wrap" id="div_type1_complnt_trade_number_3">
          <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'dbd\',\'#complnt_trade_number_IdxFs_'.$formSetId.'\',\'complnt\');"><img class="check_dbd_logo" id="check_dbd_logo_IdxFs_'.$formSetId.'" src="img/new_logo_dbd/btn_check_dbd_'.($rs_case["case_feild"]["complnt_valid_dbd"]!=""?$rs_case["case_feild"]["complnt_valid_dbd"]:"0").'.png" /></button>
          <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'ditp\',\'#complnt_trade_number_IdxFs_'.$formSetId.'\',\'complnt\');"><img class="check_ditp_logo" id="check_ditp_logo_IdxFs_'.$formSetId.'" src="'.($rs_case["case_feild"]["complnt_valid_ditp"]!=""?($rs_case["case_feild"]["complnt_valid_ditp"]=="1"?"img/logo_ditp/btn-ditp-".$rs_case["case_feild"]["complnt_valid_ditp_org"]:"img/btn_check_ditp_".$rs_case["case_feild"]["complnt_valid_ditp"]):"img/logo_ditp/btn_check_ditp_0").'.png" /></button>
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-6" id="div_complnt_name_3">
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-6 div_complnt_contact_name" id="div_complnt_contact_name_3">
        </div>
        <!-- <label class="col-sm-2 control-label control-label-r required">หมายเลขโทรศัพท์ติดต่อ</label>
        <div class="col-sm-4 flex-container">
          <div class="flex2" id="tel3">
            <input type="text" value="'.$rs_case["case_feild"]["complnt_contact_tel"].'" data-code="'.$rs_case["case_feild"]["complnt_contact_tel"].'" class="form-control tel_format phone-number-complnt input-mask" name="complnt_contact_tel_IdxFs_'.$formSetId.'" data-inputmask="&apos;mask&apos;:&apos;999-999-9999&apos;"/>
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-6 div_complnt_contact_tel" id="div_complnt_contact_tel_3">
        </div>
      </div>
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-6 div_complnt_contact_email" id="div_complnt_contact_email_3">
        </div>
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-4">
            <select name="complnt_prov_id_IdxFs_'.$formSetId.'" class="form-control select-picker" data-live-search="true">
        ...
        <div class="col-sm-4">
          <input type="text" value="'.$rs_case["case_feild"]["complnt_zipcode"].'" class="form-control input-mask" name="complnt_zipcode_IdxFs_'.$formSetId.'" data-inputmask="&apos;mask&apos;:&apos;99999&apos;"  />
        </div>
      </div>
    </div>
    <input type="hidden" name="complnt_country_id_IdxFs_'.$formSetId.'" value="162" />
  ...
  $formSet_html = '<div class="panel-body">
    ...
    <div id="collapse2" class="collapse in '.$enebledRef.'"  aria-labelledby="headingOne">
      ...
      <div class="form-group col-sm-10">
        ...
        '.($rs_case["case_feild"]["complnt_valid_dbd"]!=""?'<img class="ico_validate ico_dbd" src="img/new_logo_dbd/icon_dbd_'.$rs_case["case_feild"]["complnt_valid_dbd"].'.png" />':'').'
        '.($rs_case["case_feild"]["complnt_valid_ditp"]!=""?'<img class="ico_validate" src="img/logo_ditp/icon_ditp_'.($rs_case["case_feild"]["complnt_valid_ditp"]!="2"?$rs_case["case_feild"]["complnt_valid_ditp_org"]:($rs_case["case_feild"]["complnt_valid_ditp_org"]=="non member"?"non-member":$rs_case["case_feild"]["complnt_valid_ditp"])).'.png" />':'').'
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-8">
          <label class="text-data text-data-green">'.($rs_case["case_feild"]["complnt_prov_id"]!=""?$provinceList[$rs_case["case_feild"]["complnt_prov_id"]]:"-").'</label>
        </div>
      </div>
      ...
      <div class="form-group col-md-12">
        <div class="col-sm-12">
          <label class="control-label text-data-light text-data-alert">
            '.($rs_case["case_feild"]["complnt_valid_dbd"]=="2"?'*หมายเหตุ : '.$rs_case["case_feild"]["complnt_valid_dbd_note"]:'').'<br />
            '.($rs_case["case_feild"]["complnt_valid_ditp"]=="2"?'*หมายเหตุ : '.$rs_case["case_feild"]["complnt_valid_ditp_note"]:'').'<br />
