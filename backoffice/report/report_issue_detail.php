    ...
    <div class="col-md-12" style="padding-right:0px;">
      ...
      <div class="panel-body">
        ...
        <form method="post" action="report/export_issue.php" enctype="multipart/form-data" style="display: inline-block;margin-right: 10px;">
          ...
          <input type="hidden" name="member_comp_type_ditp" value="<?=$_POST['member_comp_type_ditp']?>">
            ...
            <div class="tabla_data">
              ...
              data-method="post">
                  <thead>
                    ...
                    <th data-field="complnt_trade_number" data-sortable="false" data-align="center">
                      เลขนิติบุคคล (ผู้ถูกร้องเรียน)
                    </th>
                    ...
                    <th data-field="officename" data-sortable="false" data-align="center">
                      สำนักที่รับผิดชอบ
                    </th>
                    ...
                    <th data-field="member_comp_type" data-sortable="false" data-align="center">
                      การเป็นสมาชิกของกรม (ผู้ร้องเรียน)
                    </th>
                    <th data-field="member_comp_type_ditp" data-sortable="false" data-align="center">
                      การเป็นสมาชิกของกรม (ผู้ถูกร้องเรียน)
                    </th>
                    <th data-field="reliable" data-sortable="false" data-align="center">
                    ...
                    <div class="row div_report">
                      ...
                      <div class="col-md-8">
                        <select class="selectpicker form-control" name="member_comp_type_ditp">
                          <option value="">- ทั้งหมด -</option>
                          <option value="0" <?php if($_POST['member_comp_type_ditp'] == "0"){ echo "selected";}?>>ไม่ระบุ</option>
                          <option value="1" <?php if($_POST['member_comp_type_ditp'] == "1"){ echo "selected";}?>>เป็นสมาชิกกรม</option>
                          <option value="2" <?php if($_POST['member_comp_type_ditp'] == "2"){ echo "selected";}?>>ไม่เป็นสมาชิกกรม</option>
                        </select>
                      </div>
                    </div>
                    <div class="row div_report">
...
function searchQueryParams(params) {
  ...
  params.member_comp_type_ditp = $("input[name='member_comp_type_ditp']").val();
...
function num_rows_issue(){
  ...
  var member_comp_type_ditp = $("input[name='member_comp_type_ditp']").val();
  ...
  $.ajax({
      ...
      data: {
        ...
        'member_comp_type_ditp':member_comp_type_ditp,
