  ...
  <div class="row row_title">
    <div class="col-md-6 box_appeal_title">
      <a href="?page=product">
        ...
        ?>
        <span class="txt_pro" ><a href="?page=product_detail&id_product=<?=$prodType_ref_id4 ?>"><?= $title4 ?></a></span>
    ...
    <div class="tabla_data">
      ...
      data-url="method.php?method=getproduct_detail_lv3"
        ...
        <div class="modal-body">
          <div class="row form-group">
            ...
            <div class="col-md-7">
              ...
              <input type="hidden" class="form-control" id="input_lv" name="input_lv" value="3">
