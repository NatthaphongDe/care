      ...
      <div id="page-content-wrapper">
        ...
        <div id="page-content">
          ...
          <div class="container">
            ...
            <link rel="stylesheet" href="../assets/widgets/bootstrap-select-1.13.14/dist/css/bootstrap-select.min.css">

            <!-- Latest compiled and minified JavaScript -->
            <!-- <script src="js/bootstrap-select.min.js"></script> -->
            <script src="../assets/widgets/bootstrap-select-1.13.14/dist/js/bootstrap-select.min.js"></script>

            <!-- (Optional) Latest compiled and minified JavaScript translation files -->
            <!-- <script src="js/bootstrap-select.js"></script> -->
            <script src="../assets/widgets/bootstrap-select-1.13.14/dist/js/bootstrap-select.js"></script>
