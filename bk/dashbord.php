...
<div class="">
  ...
  <div class="col-md-9 box_s1 box_db none_select nav_case">
    <select name="month_case_all" id="month_case_all" class="selectpicker_v" data-width="150px" onchange="ch_val();">
            ...
            <select name="year_case_all" id="year_case_all" class="selectpicker_v" data-width="150px" onchange="ch_val() && data_case_filter();">
      ...
      <div class="by_case_all" style="display: inline-block;">
        <?php
          $y_set = $date_year + 543 ;
          echo $month[ $today-1]."ปี ".$y_set;
        ?>
      </div>
      <i class="fa fa-ellipsis-v adv_se" aria-hidden="true" onclick="filter_case(0);" style="top: -5px;position: relative;"></i>
      <div style="padding: 15px; width: 630px;    " class="show_search" id="show_search_all">

                <div class="box_right">
                  <button type="button" name="btn_search_all" class="fa fa-ellipsis-v btn_adv" data-toggle="modal" data-target="#importinventory" onclick="hiddenDiv(0)"></button>
                </div>
                      ...
                      <div class="row pg_db_5">
                        ...
                        <div class="col-md-4">
                          <div class="radio radio-danger">
                            <input type="radio" value="1" name="display_case_all" id="display_id_case_1_all" onclick="chk_radio_issue_year();" checked>
                            <label class="txt_report" for="display_id_case_1_all">พ.ศ.</label>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="radio radio-danger ">
                            <input type="radio" value="2" name="display_case_all" id="display_id_case_2_all" onclick="chk_radio_issue_year();">
                            <label class="txt_report" for="display_id_case_2_all">ค.ศ.</label>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="box_filter_pd">
                    <div class="box_gp_bd">
                      <div class="row pg_db_5">
                        ...
                        <div class="col-md-4">
                          <div class="radio radio-danger">
                            <input type="radio" value="1" name="year_type_case_all" id="year_set2_1_all" onclick="chk_radio_issue();" checked>
                            <label class="txt_report" for="year_set2_1_all">ปีปฏิทิน</label>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="radio radio-danger ">
                            <input type="radio" value="2" name="year_type_case_all" id="year_set2_2_all" onclick="chk_radio_issue();">
                      ...
                      <div class="row form-group gp_year">
                        ...
                        <div class="col-md-5">
                          <div class="div_be issue_year1">
                            <select class="selectpicker form-control" name="issue_year_th_all" id="issue_year1_all" onchange="select_month_issue();">
                            ...
                            <div class="div_ad issue_year2" style="display:none">
                              <select class="selectpicker form-control" name="issue_year_en_all" id="issue_year2_all" onchange="select_month_issue();">
                                <option value="">- เลือกปี -</option>
                                <?php
                                $date_year = date("Y");
                                for($year = $date_year+1; $year>=$date_year-5; $year--){
                          ...
                          <div class="row form-group box_Quarterly">
                            ...
                            <div class="col-md-5">
                              <select class="selectpicker form-control" name="quarter_all" id="select_quarter_chk_all" onchange="select_quarter(this.value);">
                          ...
                          <div class="row form-group gp_month box_monthly">
                            ...
                            <div class="col-md-5">
                              <div class="months_issue1">
                                <select class="selectpicker form-control" name="month_issue_th_all" id="month_issue_1_all" onchange="select_month_issue();">
                                  <option value="">- เลือกเดือน -</option>
                                  <?php
                                  $months = array(
                                    "01"=>'มกราคม',
                                ...
                                <div class="months_issue2">
                                  <select class="selectpicker form-control" name="month_issue_en_all" id="month_issue_2_all" onchange="select_month_issue();">
                                    <option value="">- เลือกเดือน -</option>
                                    <?php
                                    $months = array(
                                      "01"=>'January',
                              ...
                              <div class="row form-group gp_st_date">
                                ...
                                <div class="col-md-5">
                                  <div class="input-group st_date">
                                    <div class="input-group date" id="datetimepicker_case_1_all" onchange="set_date_select()">
                                      <!-- <input type="text" class="form-control input-mask" data-inputmask="'mask':'99/99/9999'" name="date_start" id="startDate" /> -->
                                      <input type="text" class="form-control input-mask" data-inputmask="'mask':'99/99/9999'" name="date_start_all" id="startDate_all" />
                              ...
                              <div class="row gp_sp_date">
                                ...
                                <div class="col-md-5">
                                  <div class="input-group sp_date">
                                    <div class="input-group date" id="datetimepicker_case_2_all">
                                      <input type="text" class="form-control input-mask" data-inputmask="'mask':'99/99/9999'" name="date_stop_all" id="stopDate_all" />
                                      <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar color_green"></span>
                                      </span>
                                    </div>
                          ...
                          <div class="row box_btn_db" style="">
                            <button type="submit" class="btn btn_submit sb_db" name="submit_case_all">ตกลง</button>
                          </div>
                        </div>
                      </div>
