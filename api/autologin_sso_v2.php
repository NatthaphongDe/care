                        ...
                        if ($data['res_code'] == "00") {
                            ...
                            $data = $data['res_result'];
                                ...
                                if ($data['type'] == 1 || $data['type'] == 6) {
                                    ...
                                    $title = $data['sub_member'][0]['titleTh'];
                                    $title_en = $data['sub_member'][0]['titleEn'];
                                    $fname = $data['sub_member'][0]['nameTh'];
                                    $fname_en = $data['sub_member'][0]['nameEn'];
                                    $lname =  $data['sub_member'][0]['lastnameTh'];
                                    $lname_en =  $data['sub_member'][0]['lastnameEn'];
                                    $sub_member_cid =  $data['sub_member'][0]['cid'];
                                    ...
                                    $member_email = $data['sub_member'][0]['email'];
                                    $member_phone = $data['sub_member'][0]['tel'];
                                    $tel_code = $data['sub_member'][0]['tel_code'];
                                    $tel_country_code = $data['sub_member'][0]['tel_country_code'];
                                    $tel_icon_country = $data['sub_member'][0]['tel_icon_country'];
                                ...
                                if ($data['type'] == 2) {
                                    //นิติต่างชาติ
                                    $title_en = $data['sub_member'][0]['titleEn'];
                                    $fname = $data['sub_member'][0]['nameEn'];
                                    $lname =  $data['sub_member'][0]['lastnameEn'];
                                    ...
                                    $member_comp_taxid = $data['naturalId'];
                                    $member_comp_phone =  $data['sub_member'][0]['tel'];
