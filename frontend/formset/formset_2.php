    ...
    $formSet_html .='<input type="hidden" value="'.$re['member_cid'].'" name="applnt_ident_IdxFs_'.$formSetId.'" />
      ...
      if($re['member_type'] == 0){
              ...
              <div class="collapse in" id="multiCollapse">
                ...
                <div class="card card-body">
                  ...
                  <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="appint_personinfo[]" onkeypress="onlynum_validate(event)" value='.$re['member_postcode'].'> 
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card card-body">
                  ...
                  <div class="row flexcenter">
                    ...
                    <div class="col-sm-2 flexcenter">
                      <select class="custom-select " name="appint_personinfo1[]" onchange="showOther()">
                  ...
                  <div class="row flexcenter">
                      ...
                      <div class="col-sm-4 flex-container" style="margin-left: 3px;">
                        <div class="flex2" id="tel1">
                          <input type="text" value="'.$rs_case["case_feild"]["applnt_mobile"].'" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control phone-number" name="appint_personinfo1[]"  onkeypress="onlynum_validate(event)" />
        ...
        <span class="icon_invite_home"><img src="images/icon_invite_home.png"></span>';
          if($lang == "1"){ $hr_lcom2 = "บริษัทที่จดทะเบียน";}elseif($lang == "2"){ $hr_lcom2 = "Registered company";}else{ $hr_lcom2 = "บริษัทที่จดทะเบียน";}
        $formSet_html .='<span class="hr_invite_company">'.$hr_lcom2.'</span>
        </div>
              ...
              <div class="collapse in" id="multiCollapse">
                ...
                <div class="card card-body">
                  ...
                  <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="" name="appint_personinfo[]" value='.$re['member_cid'].' onkeypress="onlynum_validate(event)">
                    </div>
          ...
          <div class="form-check">
              ...
              <div class="card card-body">
                  ...
                  <div class="row flexcenter">
                      ...
                      <div class="col-sm-4 flex-container" style="margin-left: 3px;">
                        <div class="flex2" id="tel1">
                          <input type="text" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control phone-number" name="appint_personinfo1[]"  value="' . $re['member_comp_phone'] . '" onkeypress="onlynum_validate(event)" />
                  ...
                  <div class="row flexcenter"">
                    ...
                    <input type="hidden" name="appIntOrg_countryname" id="appIntOrg_countryname" value="">
                      ...
                      <div class="col-sm-4">
                      <input type="text" class="form-control" name="appint_personinfo1[]" value="' . $re['member_postcode'] . '"> 
                      </div>
                  </div>
                  </div>
              </div>
...
if($re['country_id'] == 162 && $rel['compType_other_flag'] == 0){
  $formSet_html .='
  <div class="panel panel-default" style="margin-top: 20px; display:none;">
  <div class="panel-body">
    ...
    if($lang == "1"){ $tel_form2 = "เบอร์โทรศัพท์";}elseif($lang == "2"){ $tel_form2 = "Telephone Number";}else{ $tel_form2 = "เบอร์โทรศัพท์";}
      ...
      <div class="col-md-3"><input type="text" class="form-control applntOrg_tel" name="applntOrg_tel_IdxFs_'.$formSetId.'" /></div>';
    ...
    if($lang == "1"){ $zipcode_form2 = "รหัสไปรษณีย์";}elseif($lang == "2"){ $zipcode_form2 = "Postcode";}else{ $zipcode_form2 = "รหัสไปรษณีย์";}
      $formSet_html .='<div class="col-md-3 applntOrg_zipcode_txt">'.$zipcode_form2.'<span style="color:#E74C3C;">*</span></div>
      <div class="col-md-3"><input type="text" class="form-control applntOrg_zipcode" maxlength="5" pattern="([0-9]|[0-9]|[0-9])" name="applntOrg_zipcode_IdxFs_'.$formSetId.'" /></div>
    ...
    //               </div>
    //               <div class="col-sm-4" style="margin-left: 3px;">
    //                 <input type="text" class="form-control" name="Represent_value[]" value="-"> 
    //               </div>
    //               <div class="col-sm-2 textend">
    //                 '.$lang_10.'<span style="color:#E74C3C;">*</span>
    //               </div>
    //               <div class="col-sm-4">
    //                 <input type="text" class="form-control" name="Represent_value[]"> 
    //               </div>
...
$rel = $query_from->fetch_assoc();
  ...
  if($re['country_id'] == 162 && $rel['compType_other_flag'] == 0){
    ...
    <div class="panel-body">
      ...
      <input type="hidden" value="1" name="applnt_type_IdxFs_'.$formSetId.'"  />
      <div class="row div_contacts_invite">';
      if($lang == "1"){ $cn_form2 = "ชื่อบริษัท1";}elseif($lang == "2"){ $cn_form2 = "Company Name";}else{ $cn_form2 = "ชื่อบริษัท1";}
      $formSet_html .='<div class="col-md-3">'.$cn_form2.'<span style="color:#E74C3C;">*</span></div>
      ...
      if($lang == "1"){ $zipcode_form2 = "รหัสไปรษณีย์";}elseif($lang == "2"){ $zipcode_form2 = "Postcode";}else{ $zipcode_form2 = "รหัสไปรษณีย์";}
        $formSet_html .='<div class="col-md-3 applntOrg_zipcode_txt">'.$zipcode_form2.'<span style="color:#E74C3C;">*</span></div>
        <div class="col-md-3"><input type="text" class="form-control applntOrg_zipcode" maxlength="5" pattern="([0-9]|[0-9]|[0-9])" name="applntOrg_zipcode_IdxFs_'.$formSetId.'" value="'.$_POST['applntOrg_zipcode'].'" /></div>
        <div class="col-md-2"></div>
        <div class="col-md-4"></div>
      </div>
      <div class="row div_contacts_invite">';
      if($lang == "1"){ $country_form2 = "ประเทศ";}elseif($lang == "2"){ $country_form2 = "Country";}else{ $country_form2 = "ประเทศ";}
        ...
        if($lang == "1"){ $chcountry_form3 = "เลือกประเทศ";}elseif($lang == "2"){ $chcountry_form3 = "Choose your country";}else{ $chcountry_form3 = "เลือกประเทศ";}
         ...
         --- '.$chcountry_form3.' ---
          ...
          $sql = "select * from Country WHERE id != '162' ORDER BY name";
