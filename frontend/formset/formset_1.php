...
if ($_GET['page'] == "invite_form") {
  ...
  $hr_form1 = (($lang == "2") ? "Claimant" : "ผู้ร้องเรียน");
  ...
  $formSet_html .=    '<div class="row">
                        <div class="col-md-12">
                          ...
                          <input type="hidden" value="' . $re['member_cid'] . '" name="applnt_ident_IdxFs_' . $formSetId . '" />
  ...
  if ($re['country_id'] != 162 && $rel['compType_other_flag'] == 0) {
    ...
    $pov_form3 = (($lang == '2') ? 'Province' : 'จังหวัด');
    $pov_form3_ex = (($lang == '2') ? 'Choose your province"' : 'เลือกจังหวัด');
    ...
    $zipcode_form3 = (($lang == '2') ? 'Postcode"' : 'รหัสไปรษณีย์');

    // if($lang == "1"){ $zipcode_form3 = "รหัสไปรษณีย์";}elseif($lang == "2"){ $zipcode_form3 = "Postcode";}else{ $zipcode_form3 = "รหัสไปรษณีย์";}

    $hr_Country1 = (($lang == '2') ? 'Country"' : 'ประเทศ');
    $chcountry_form3 = (($lang == '2') ? 'Choose your country"' : 'เลือกประเทศ');
    ...
    $formSet_html .=      '<div class="panel panel-default" style="margin-top: 20px;">
                            <div class="panel-body">
                              ...
                              <div class="row div_contacts_invite">
                                <div class="col-md-3">' . $hr_Contact1 . '<span style="color:#E74C3C;">*</span></div>
                              ...
                              <div class="row div_contacts_invite">
                                <div class="col-md-3">' . $hr_tel1 . '<span style="color:#E74C3C;">*</span></div>
                                <div class="col-md-3">
                                  <input type="text" class="form-control applntOrg_tel cc" name="applntOrg_tel_IdxFs_' . $formSetId . '"  data-inputmask="&apos;mask&apos;:&apos;999-999-9999&apos;"/>
                                </div>
                                <div class="col-md-2 applntOrg_fax_txt" style="text-align:right;">' . $hr_ftel1 . '</div>
                                  <div class="col-md-4"><input type="text" class="form-control applntOrg_fax" name="applntOrg_fax_IdxFs_' . $formSetId . '"  /></div>
                                </div>
                                <div class="row div_contacts_invite">
                                  <div class="col-md-3">' . $pov_form3 . '<span style="color:#E74C3C;">*</span></div>
                                  <div class="col-md-3">
                                    <select name="applntOrg_prov_id_IdxFs_' . $formSetId . '" id="sel_prov_invite" class="selectpicker form-control sel_prov_invite" data-live-search="true">
                                      <option value="">--- ' . $pov_form3_ex . ' ---</option>
                                      ' . $provinceList_pers . '
                                    </select>
                                  </div>
                                  <div class="col-md-2 txt_email_invite">' . $zipcode_form3 . '<span style="color:#E74C3C;">*</span></div>
                                  <div class="col-md-4">
                                    <input type="text" name="applntOrg_zipcode_IdxFs_' . $formSetId . '" maxlength="5" pattern="([0-9]|[0-9]|[0-9])" class="form-control complnt_zipcode">
                                  </div>
                                </div>
                                <!-- /.div_contacts_invite -->

                                <div class="row div_contacts_invite">
                                  <div class="col-md-3">' . $hr_Country1 . '<span style="color:#E74C3C;">*</span></div>
                                  <div class="col-md-9">
                                    <select name="applnt_country_id_IdxFs_' . $formSetId . '" id="sel_country_invite_" class="selectpicker form-control sel_country_invite_" data-live-search="true">
                                      <option value="">--- ' . $chcountry_form3 . ' ---</option>
                                      ' . $countryList . '
                                    </select>
                                  </div>
                                </div>
  ...
  if ($re['member_type'] == 0) {
             ...
             <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                ...
                <div class="col-sm-4 flex-container">
                  <div class="flex2" id="tel1">
                    <input type="text" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'" maxlength="10"  class="form-control phone-number-info" name="appint_personinfo[]" value=' . $re['member_phone'] .'  onkeypress="onlynum_validate(event)" />
                    <input type="hidden" name="applnt_mobile_country" value="'.$re['tel_country_code'].'">
              ...
              <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                ...
                <div class="col-sm-4">
                  <input type="text" id="zipcode" class="form-control input-mask" maxlength="5" name="appint_personinfo[]"  onkeypress="onlynum_validate(event)" value=' . $re['member_postcode'] . ' data-inputmask="&apos;mask&apos;:&apos;99999&apos;"> 
                  </div>
              </div>
            </div>
          </div>
        ...
        <div class="flexcenter">
          ...
          <div class="card card-body">
              ...
              <div class="row flexcenter">
                  ...
                  <div class="col-sm-4 flex-container" style="margin-left: 3px;"style="margin-left: 3px;">
                  <div class="flex2" id="tel1">
                      <input type="text" value="'.$rs_case["case_feild"]["applnt_mobile"].'" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'" maxlength="10"  class="form-control phone-number" name="appint_personinfo1[]"  onkeypress="onlynum_validate(event)" />
              ...
              <div class="row flexcenter"">
                  ...
                  <div class="col-sm-4">
                  <input type="text" class="form-control" maxlength="5" value="" name="appint_personinfo1[]" onkeypress="onlynum_validate(event)"> 
                  </div>
              </div>
              </div>
          </div>
    ...
    <div class="Newpanel-header">
      <div class="row">
          <div class="collapse in" id="multiCollapse">
            <input type="hidden" name="appint_personinfo[]" value=' . $_SESSION['member_id'] . '>
            <input type="hidden" name="appint_personinfo[]" id="member_type" value=' . $re['member_type'] . '>
            <div class="card card-body">
              <div class="row flexcenter" style="margin-left:0px; margin-right:0px;">
                <div class="col-sm-2">
                  ' . $lang_21 . '<span style="color:#E74C3C;">*</span>
              ...
              <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" name="appint_personinfo[]" value=' . $re['member_cid'] .' maxlength="13" onkeypress="onlynum_validate(event)">
                </div>
              ...
              <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                ...
                <div class="col-sm-4 flex-container">
                  <div class="flex2" id="tel1">
                    <input type="text" value="' . $re['member_phone'] .'" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control phone-number-info" name="appint_personinfo[]"  maxlength="10" onkeypress="onlynum_validate(event)"  />
              ...
              <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" maxlength="5" name="appint_personinfo[]" onkeypress="onlynum_validate(event)" value=' . $re['member_postcode'] . '> 
                </div>
              </div>
            </div>
          </div>
    ...
    $formSet_html .=
          ...
          <div class="card card-body">
              ...
              <div class="row flexcenter">
                  ...
                  <div class="col-sm-4 flex-container" style="margin-left: 3px;">
                    <div class="flex2" id="tel1">
                      <input type="text" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control phone-number" name="appint_personinfo1[]"  value="' . $re['member_comp_phone'] . '" maxlength="10" onkeypress="onlynum_validate(event)"  />
                      <input type="hidden" name="applntOrg_mobile_country" value="">
                      <input type="hidden" name="applntOrg_mobile_code" value="">
                    </div>
                  </div>
      ...
      <div class="form-check">
          ...
          <div class="collapse" id="collapseperson2">
          <div class="card card-body">
              <div class="card-header flexcenter">
              <i class="bi bi-person-fill fa-2x"></i>
              <span>' . $lang_18 . '</span>
  ...
  $formSet_html .=        '</div>
                    ...
                    <!-- /.collapse_1 panel panel-default -->';
} else if ($_GET['page'] == "invite_edit") {
  $rdi_compTypeSub1 = (($_POST["rdi_compTypeSub1"] == '') ? 0 : $_POST["rdi_compTypeSub1"]);
  // if($_POST["rdi_compTypeSub1"] == ""){ $rdi_compTypeSub1 = 0;}else{ $rdi_compTypeSub1 = $_POST["rdi_compTypeSub1"];}
  ...
  if ($re['country_id'] != 162 && $rel['compType_other_flag'] == 0) {
    ...
    if ($query->num_rows > 0) {
      while ($rs = $query->fetch_assoc()) {
        ...
        //   $prov_name = $rs["prov_name"];
        // }
        $prov_name = $rs['prov_name' . (($lang == '2') ? '_eng' : '')];
    ...
    if ($query->num_rows > 0) {
      while ($rs = $query->fetch_assoc()) {
        ...
        //   $name = $rs['name'];
        // }
        $formSet_html .=        '<option value="' . $rs['id'] . '" ' . ($_POST["applnt_country_id"] == $rs['id'] ? 'selected' : '') . '>' . $rs['name'] . '</option>';
      }
    }
    $formSet_html .=            '</select>
                                </div>
          ...
          <input type="hidden" name="appint_personinfo[]" value="">
            <div class="card card-body">
              ...
              <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                ...
                <div class="col-sm-4 flex-container">
                    <div class="flex2" id="tel1">
                    <input type="text" value="'.$rs_case["case_feild"]["applnt_mobile"].'" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control phone-number-info" name="appint_personinfo[]"  maxlength="10" onkeypress="onlynum_validate(event)"  />
                    <input type="hidden" name="applnt_mobile_country" value="">
                    <input type="hidden" name="applnt_mobile_code" value="">
                  </div>
                </div>
        ...
        <div class="form-check">
          ...
          <div class="card card-body">
              ...
              <div class="row flexcenter">
                  ...
                  <div class="col-sm-4 flex-container" style="margin-left: 3px;">
                    <div class="flex2" id="tel1">
                      <input type="text" value="'.$rs_case["case_feild"]["applnt_mobile"].'" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control phone-number" name="appint_personinfo1[]"  value="' . $re['member_comp_phone'] . '" maxlength="10" onkeypress="onlynum_validate(event)"  />
                      <input type="hidden" name="applntOrg_mobile_country" value="">
                      <input type="hidden" name="applntOrg_mobile_code" value="">
                    </div>
                  </div>
          ...
          <input type="hidden" name="appint_personinfo[]" value="">
            <div class="card card-body">
              ...
              <div class="row flexcenter" style="margin-left:0px; margin-right:0px; margin-top: 8px;">
                ...
                <div class="col-sm-4 flex-container">
                    <div class="flex2" id="tel1">
                    <input type="text" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control phone-number-info" name="appint_personinfo[]"  maxlength="10" onkeypress="onlynum_validate(event)"  />
                    <input type="hidden" name="applnt_mobile_country" value="">
                    <input type="hidden" name="applnt_mobile_code" value="">
                  </div>
                </div>
  ...
  //                   <!-- panel-body -->
  //                 </div>
  //                 <!-- / #collapse_1 /.panel-collapse collapse -->';
} // page is invite_edit
?>
<script>
