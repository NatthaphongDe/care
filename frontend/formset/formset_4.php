...
<div class="panel-body">';
  ...
  if($lang == "1"){ $tel_form4 = "หมายเลขโทรศัพท์ที่ติดต่อ";}elseif($lang == "2"){ $tel_form4 = "Telephone Number";}else{ $tel_form4 = "หมายเลขโทรศัพท์ที่ติดต่อ";}
    ...
    <div class="col-sm-4 flex-container">
      <div class="flex2" id="tel2">
        <input type="text" value="'.$rs_case["case_feild"]["applnt_mobile"].'" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control phone-number-complnt txt_input_tel_invite" name="complnt_contact_tel_IdxFs_'.$formSetId.'" onkeypress="onlynum_validate(event)" />
  ...
  <div class="row div_country_invite">';
    ...
    <div class="col-md-3"><input type="text"  name="complnt_zipcode_IdxFs_'.$formSetId.'"  class="form-control "></div>
  </div>
