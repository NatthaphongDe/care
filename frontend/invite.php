...
<input type="hidden" value="<?php echo $rl['member_condition'] ?>" class="member_condition">
    ...
    <form method="post" action="?page=invite_form" id="chk_invite_step1" enctype="multipart/form-data">
      <div class="invite_step1">
        ...
        <div class="panel panel-default">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="select_invite">
                <select name="rdi_compType_id" class="selectpicker form-control select_invite_box slct_comp_type" id="rdi_compType_id">
                  <option value="">
                    --- <?= $txt_Type_petition ?> ---
                  </option>
                  <?php
                  foreach ($case_cls->comp_type_new  as $comp_type_list) {
                  ?>
              ...
              <div class="radio_invite">
                ...
                ?>
                    <div class="form-group col-md-12 div_compTypeSub1ByCompType" id="div_compTypeSub1ByCompType_<?php echo $comp_type_list["compType_id"] ?>" style=" display:none;">
                      <?php
                      foreach ($comp_type_list["compTypeSub1_list"] as $compTypeSub1_list) {
                      ?>
                        <div class="radio radio-success col-xs-12">

                          <input type="radio" class="rdi_compTypeSub1" id="compType1_id_create_<?php echo $compTypeSub1_list["compTypeSub1_id"] ?>" name="rdi_compTypeSub1" value="<?php echo $compTypeSub1_list["compTypeSub1_id"] ?>">
                          <label class="text-data-light" for="compType1_id_create_<?php echo $compTypeSub1_list["compTypeSub1_id"] ?>">
                            <?php
                            if ($lang == "1") {
            ...
            <div class="form-group col-md-12 div_compTypeSub1ByCompType_other" style="display:none;">
              <div class="panel panel-default panel_invite_orter">
                <div class="panel-body">
                  <div class="col-xs-12">
                    <span class="col-xs-2">โปรดระบุ</span>
                    <div class="col-xs-6">
                        ...
                        <div class="radio_sub_invite">
                          ...
                          <div class="panel-body panel-body-outer-bg2 panel-emp-assign div_compTypeSub2BycompTypeSub1" id="div_compTypeSub2BycompTypeSub1_<?php echo $compTypeSub1_list["compTypeSub1_id"] ?>" style="padding: 0px;">
                            <div class="col-md-12 panel-body-bg2">
                              ...
                              ?>
                                <div class="radio radio-success col-xs-12">
                                  <input type="radio" class="rdi_compTypeSub2" id="compType2_id_create_<?php echo $compTypeSub2_list["compTypeSub2_id"] ?>" name="rdi_compTypeSub2" value="<?php echo $compTypeSub2_list["compTypeSub2_id"] ?>">
                                  <label class="text-data-light" for="compType2_id_create_<?php echo $compTypeSub2_list["compTypeSub2_id"] ?>">
                                    <?php
                                    if ($lang == "1") {
        ...
        <div class="btn-div">
          ...
          ?>
          <button class="btn btn-warning form-control btn-chk-invite" type="button"><?=$submit_text;?></button>
        </div>
      </div> <!-- invite step1 -->
    </form>
  </div>
...
<script>
  ...
  $(document).ready(function() {
    $('.slct_comp_type option:first').prop('selected', true);
    $('.slct_comp_type').selectpicker('refresh');
    ...
    $('.slct_comp_type').bind("change", function(event) {
      ...
      if (compTypeId_other_flag == 0) {
        $('.btn-chk-invite').prop('disabled', false);
        ...
        window.location.href = 'https://www.ditp.go.th/ditp_web61/formgenerator_view.php?id=67';
        // $('.btn-chk-invite').prop('disabled', true);
        $(".div_compTypeSub1ByCompType").css("display", "none");
        $(".panel_invite_box").css("display", "none");
    ...
    $('.rdi_compTypeSub1').bind("click", function(event) {
      ...
      $(".div_compTypeSub1ByCompType").css("margin-bottom", "0px");
    });
  });
</script>