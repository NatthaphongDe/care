  ...
  function send_dbd_status(status,frmset,frmType, com_name, com_address){
    if(status=="1"){
      if(confirm("กรุณายืนยันผลตรวจสอบ \"ข้อมูลถูกต้อง\" ")){
        $(window.opener.document).find("#check_dbd_logo_IdxFs_"+frmset).attr("src","img/btn_check_dbd_1.png");
      ...
      if(confirm("กรุณายืนยันผลตรวจสอบ \"ข้อมูลไม่ถูกต้อง\" ")){
        $(window.opener.document).find("#check_dbd_logo_IdxFs_"+frmset).attr("src","img/btn_check_dbd_2.png");
