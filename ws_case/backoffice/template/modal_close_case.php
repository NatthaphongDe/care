...
<div class="modal fade" id="model_close_case" tabindex="-1" role="dialog" aria-labelledby="model_close_label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
          <form class="form-horizontal frm_case_close" name="frm_case_close" enctype="multipart/form-data" method="post" action="function.php?method=close_case" target="iframe-data">
