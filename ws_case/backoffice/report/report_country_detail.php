  ...
  <div class="row">
    <div class="col-md-12" style="padding-right:0px;">
      ...
      <div class="panel-body">
          <div class="hr_report" style="display:inline-block;">รายงานเรื่องร้องเรียนแยกตามประเทศผู้ร้องเรียน
    ...
    color: #000;
          ...
          <div style="margin-top:10px;">
            ...
            <div class="tabla_data">
              ...
              data-url="report/report_table_all.php?method=report_country"
              ...
              data-method="post">
                  <thead>
                    ...
                    <th data-field="name_th" data-sortable="true" data-width="80%" align="left">
                      ประเทศ
                    </th>
                    <th data-field="country_num" data-sortable="true" data-align="center" data-width="15%">
              ...
              <div class="panel-body">
                <div class="row date_issue">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <input name="Country_applnt" type="hidden" />
                    <!-- <div class="row div_report">
                    ...
                    <div class="row div_report">
                      ...
                      <div class="col-md-8">
                        <select class="selectpicker form-control" name="status_complaint">
                          ...
                          <option value="5" <?php if($_POST['status_complaint'] == "5"){ echo "selected";}?>>Close(overdue)</option>
                        </select>
                      </div>
                    </div>
                    <div class="row div_report">
...
$(document).ready(function() {
    ...
    //     };
      ...
      // async function chart (result) {
      //   console.log(result.chart.height);
      //     if(result.chart.height < 351){
      //       $('#chart').html('');
      //       $('#chart').show('');
      //       var chart =  new  ApexCharts(document.querySelector("#chart"), result);
      //       chart.render();
      //       $('#chart2').hide();
      //       $('#chart3').hide();
      //     }

      //     if(result.chart.height > 350 ){
      //       $('#chart2').html('');
      //       $('#chart2').show();
      //       var chart =  new  ApexCharts(document.querySelector("#chart2"), result);
      //       chart.render();
      //       $('#chart').hide();
      //       $('#chart3').hide();
      //     }

      //     if(result.chart.height > 1750 ){
      //       $('#chart3').html('');
      //       $('#chart3').show();
      //       var chart =  new  ApexCharts(document.querySelector("#chart3"), result);
      //       chart.render();
      //       $('#chart').hide();
      //       $('#chart2').hide();
      //     }
      ...
      //   const options = getdata(name.rows);
...
function num_rows_issue(){
  ...
  $.ajax({
      url: 'report/num_rows_report_country.php',
      type: 'POST',
      async: false,
      responseType: "json",
      data: {
    ...
    success: function(res) {
      ...
      $('.total-closesuccess-issue').text("Close ตกลงกันได้ "+res.closesuccess+",");
      $('.total-closecontinue-issue').text("Close ผู้ร้องดำเนินการต่อ "+res.closecontinue+",");
      $('.total-closereject-issue').text("Close กรมไม่สามารถดำเนินการได้  "+res.closereject+",");
      ...
      $('.export-closesuccess-issue').val("Close ตกลงกันได้ "+res.closesuccess+",");
      $('.export-closecontinue-issue').val("Close ผู้ร้องดำเนินการต่อ "+res.closecontinue+",");
      $('.export-closereject-issue').val("Close กรมไม่สามารถดำเนินการได้  "+res.closereject+",");
