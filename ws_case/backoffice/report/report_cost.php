...
<form method="post" action="index.php?page=report/report_cost_detail" id="cost_filter" enctype="multipart/form-data">
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-default panel-report">
    <div class="panel-body">
      <div class="hr_report">รายงานมูลค่าความเสียหาย</div>
      <div class="row">
              ...
              <div class="panel-body">
                <div class="row row-margin">
                  ...
                  <div class="radio radio-success col-md-2 col-sm-4 col-xs-6">
                    <input type="radio" value="1" name="year_set_1" id="year_set1_1_cost" onclick="chk_radio_cost_year();" checked>
                    <label class="txt_report" for="year_set1_1_cost">พ.ศ.</label>
                  </div>
                  <div class="radio radio-success col-md-4 col-sm-4 col-xs-6">
                    <input type="radio" value="2" name="year_set_1" id="year_set1_2_cost" onclick="chk_radio_cost_year();">
          ...
          <div class="panel panel-default" style="background-color: #eceff1;">
              <div class="panel-body">
                <div class="row row-margin">
                  ...
                  <div class="radio radio-success col-md-2 col-sm-4 col-xs-6">
                    <input type="radio" value="1" name="year_set_2" id="year_set2_1_cost" onclick="chk_radio_cost();" checked>
                    <label class="txt_report" for="year_set2_1_cost">ปีปฏิทิน</label>
                  </div>
                  <div class="radio radio-success col-md-4 col-sm-4 col-xs-6">
                    <input type="radio" value="2" name="year_set_2" id="year_set2_2_cost" onclick="chk_radio_cost();">
        ...
        <div class="panel panel-default" style="background-color: #eceff1;">
          <div class="panel-body">
            <div class="row div_report date_cost row-margin">
            ...
            <div class="row div_report date_cost date_cost_panel">
              ...
              <div class="col-md-4 col-xs-12" id="quarter_txt">
                <select class="selectpicker form-control" name="quarter" id="select_quarter_chk_cost" onchange="select_quarter_cost(this.value);">
            ...
            <div class="row div_report date_cost date_cost_panel">
              ...
              <div class="col-md-4 col-xs-12">
                ...
                <select class="selectpicker form-control" name="month_cost_th" id="month_cost_1" onchange="select_month_cost();">
                ...
                <select class="selectpicker form-control" name="month_cost_en" id="month_cost_2" onchange="select_month_cost();">
                  <option value="">- เลือกเดือน -</option>
                  <?php
                  $months = array(
                            "01"=>'January',
        ...
        <div class="panel panel-default date_issue_panel" style="background-color: #eceff1;">
          <div class="panel-body">
            <div class="row date_cost row-margin">
      ...
      <div class="panel panel-default" style="background-color: #eceff1;">
        <div class="panel-body">
          <div class="row div_report">
            ...
            <div class="col-md-3">
            <input type="number" class="form-control" name="damage_start">
            </div>
            <div class="col-md-1" style="text-align:center;">ถึง</div>
            <div class="col-md-3">
              <input type="number" class="form-control" name="damage_end">
            </div>
          ...
          <div class="row div_report">
            ...
            <div class="col-md-2">
              <select class="selectpicker form-control" name="Currency">
                ...
                ?>
                <option value="<?=$rx['curren_id']?>"><?=$rx['curren_name'];?></option>
                <?php } ?>
              </select>
            </div>
    ...
    <div class="btn-report-cost">
      <button type="button" class="btn btn-success submit_report_cost">ตกลง</button>
    </div>
  </div>
  </div>
</div>
