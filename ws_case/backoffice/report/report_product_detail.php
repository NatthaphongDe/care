    ...
    color: #000;
          ...
          <div style="margin-top:10px;">
            ...
            <div class="tabla_data">
              ...
              data-url="report/report_table_all.php?method=report_product"
              ...
              data-method="post">
                  <thead>
                    ...
                    <th data-field="prodType_name" data-sortable="false" data-width="10%" align="left">
                      ปี (ปฏิทิน)
                    </th>
                    <th data-field="num_case" data-sortable="false" data-align="center" data-width="15%">
...
$(document).ready(function() {
    ...
    $.each(name.rows, function( index, val ) {
        name_chart.push(val.prodType_name);
        value_chart.push(val.num_case);
    });
...
function num_rows_issue(){
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      $('.total-closereject-issue').text("Close ไม่สามารถดำเนินการได้  "+res.closereject+",");
      ...
      $('.export-closereject-issue').val("Close ไม่สามารถดำเนินการได้  "+res.closereject+",");
