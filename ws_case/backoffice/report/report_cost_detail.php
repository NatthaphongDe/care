  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel-body">
          <div class="hr_report" style="display:inline-block;">รายงานมูลค่าความเสียหาย
          ...
          <div class="total-report" style="position:absolute;">
            ...
            <span class="total-case-cost"></span>
            <span class="open-cost">(</span>
            <span class="total-waiting-cost"></span>
            <span class="total-new-cost"></span>
            <span class="total-pending-cost"></span>
            <span class="total-overduemain-cost"></span>
            <span class="total-overduesub-cost"></span>
            <span class="total-closesuccess-cost"></span>
            <span class="total-closecontinue-cost"></span>
            <span class="total-closereject-cost"></span>
            <span class="total-close-cost"></span>
            <span class="end-cost">)</span>
          </div>
          <div class="filter_report" style="margin-left:10px;">
          <button class="btn btn-filter" onclick="modal_chk_cost();"><i class="fa fa-filter" aria-hidden="true" style="margin-right:5px;"></i>Filter</button>
          <form method="post" action="report/export_cost.php" enctype="multipart/form-data" style="display: inline-block;margin-right: 10px;">
            ...
            <input type="hidden" class="cost_year_th" name="cost_year_th" value="<?=$_POST['cost_year_th']?>">
            <input type="hidden" class="cost_year_en" name="cost_year_en" value="<?=$_POST['cost_year_en']?>">
            <input type="hidden" class="quarter" name="quarter" value="<?=$_POST['quarter']?>">
            <input type="hidden" class="month_cost_th" name="month_cost_th" value="<?=$_POST['month_cost_th']?>">
            <input type="hidden" class="month_cost_en" name="month_cost_en" value="<?=$_POST['month_cost_en']?>">
            ...
            <input type="hidden" name="damage_start" value="<?=$_POST['damage_start']?>">
            <input type="hidden" name="damage_end" value="<?=$_POST['damage_end']?>">
            <input type="hidden" name="Currency" value="<?=$_POST['Currency']?>">
            <input type="hidden" name="office_id" value="<?=$_POST['office_id']?>">

            <input type="hidden" class="export-case-cost" name="case">
            <input type="hidden" class="export-waiting-cost" name="waiting">
            <input type="hidden" class="export-new-cost" name="new">
            <input type="hidden" class="export-pending-cost" name="pending">
            <input type="hidden" class="export-overduemain-cost" name="overduemain">
            <input type="hidden" class="export-overduesub-cost" name="overduesub">
            <input type="hidden" class="export-closesuccess-cost" name="closesuccess">
            <input type="hidden" class="export-closecontinue-cost" name="closecontinue">
            <input type="hidden" class="export-closereject-cost" name="closereject">
            <input type="hidden" class="export-close-cost" name="close">
          ...
          <div>
            ...
            <div class="tabla_data">
              ...
              data-url="report/report_table_cost.php?method=report_cost"
              ...
              data-method="post">
                  <thead>
                    ...
                    <th data-field="case_id" data-sortable="false" data-align="center">
                      เลขที่เคส
                    </th>
                    ...
                    <th data-field="caseDtl_damage_val" data-sortable="true" data-align="center">
                      มูลค่าความเสียหาย
                    </th>
                    ...
                    <th data-field="case_status" data-sortable="false" data-align="center">
                      สถานะบริษัท (Watchlist, Blacklist)
                    </th>
                  </tr>
                </thead>
              </table>
...
<form method="post" action="#" id="modal_filter_cost" enctype="multipart/form-data">
		<div class="modal fade" id="modal_chk_cost" tabindex="-1" role="dialog" aria-labelledby="modal_chk_cost" style="padding:0px;">
			<div class="modal-dialog modal_chk_cost" role="document" style="width:1200px;">
              ...
              <div class="row" style="margin-top:30px;">
                ...
                <div class="col-md-10">
                  <div class="panel panel-default" style="background-color: #eceff1;">
                      <div class="panel-body">
                        <div class="row">
                          <div class="col-md-2 col-sm-4 col-xs-4">การแสดงผล</div>
                          <div class="radio radio-success col-md-2 col-sm-4 col-xs-4">
                            <input type="radio" value="1" name="year_set_1" id="year_set1_1_cost" onclick="chk_radio_cost_year_modal();" <?php if($_POST['year_set_1'] == "1"){ echo "checked";}?>>
                            <label class="txt_report" for="year_set1_1_cost">พ.ศ.</label>
                          </div>
                          <div class="radio radio-success col-md-4 col-sm-4 col-xs-4">
                            <input type="radio" value="2" name="year_set_1" id="year_set1_2_cost" onclick="chk_radio_cost_year_modal();" <?php if($_POST['year_set_1'] == "2"){ echo "checked";}?>>
                            <label class="txt_report" for="year_set1_2_cost">ค.ศ.</label>
                          </div>
                  ...
                  <div class="panel panel-default" style="background-color: #eceff1;">
                      <div class="panel-body">
                        <div class="row">
                          <div class="col-md-2 col-sm-4 col-xs-4">ประเภทปี</div>
                          <div class="radio radio-success col-md-2 col-sm-4 col-xs-4">
                            <input type="radio" value="1" name="year_set_2" id="year_set2_1_cost" onclick="chk_radio_cost_modal();" <?php if($_POST['year_set_2'] == "1"){ echo "checked";}?>>
                            <label class="txt_report" for="year_set2_1_cost">ปีปฏิทิน</label>
                          </div>
                          <div class="radio radio-success col-md-4 col-sm-4 col-xs-4">
                            <input type="radio" value="2" name="year_set_2" id="year_set2_2_cost" onclick="chk_radio_cost_modal();" <?php if($_POST['year_set_2'] == "2"){ echo "checked";}?>>
                            <label class="txt_report" for="year_set2_2_cost">ปีงบประมาณ</label>
                          </div>
                          <div class="col-md-4"></div>
                        </div>
                      </div>
                ...
                <div class="panel panel-default" style="background-color: #eceff1;">
                  <div class="panel-body">
                    <div class="row div_report date_cost">
                      <div class="col-md-2 col-xs-12">ช่วงเวลา</div>
                      <div class="col-md-1 col-xs-12">
                        <span class="txt_report">รายปี</span>
                      </div>
                      <div class="col-md-4 col-xs-12">
                        <div class="cost_year1">
                        <select class="selectpicker form-control" name="cost_year_th" id="cost_year1" onchange="select_month_cost();">
                          ...
                          for($year = $date_year+1; $year>=$date_year-5; $year--){
                            $year_sum = $year+543;
                          ?>
                          <option value="<?=$year;?>" <?php if($_POST['cost_year_th'] == $year){ echo "selected";}?>><?=$year_sum;?></option>
                          <?php  } ?>
                        </select>
                      </div>
                      <div class="cost_year2">
                        <select class="selectpicker form-control" name="cost_year_en" id="cost_year2" onchange="select_month_cost();">
                          <option value="">- เลือกปี -</option>
                          <?php
                          $date_year = date("Y");
                          for($year = $date_year+1; $year>=$date_year-5; $year--){
                          ?>
                          <option value="<?=$year;?>" <?php if($_POST['cost_year_en'] == $year){ echo "selected";}?>><?=$year;?></option>
                          <?php  } ?>
                        </select>
                      </div>
                    ...
                    <div class="row div_report date_cost date_cost_panel">
                      <div class="col-md-2"></div>
                      <div class="col-md-1 col-xs-12">
                        <span class="txt_report">รายไตรมาส</span>
                      </div>
                      <div class="col-md-4 col-xs-12">
                        <select class="selectpicker form-control" name="quarter" id="select_quarter_chk_cost" onchange="select_quarter_cost_modal(this.value);">
                    ...
                    <div class="row div_report date_cost date_cost_panel">
                      ...
                      <div class="col-md-4 col-xs-12">
                        <div class="months_cost1">
                        <select class="selectpicker form-control" name="month_cost" id="month_cost_1" onchange="select_month_cost();">
                          ...
                          ?>
                          <option value="<?=$key?>" <?php if($_POST['month_cost_th'] == $key){ echo "selected";}?>><?=$value?></option>
                          <?php } ?>
                        </select>
                      </div>

                        <div class="months_cost2">
                        <select class="selectpicker form-control" name="month_cost" id="month_cost_2" onchange="select_month_cost();">
                          <option value="">- เลือกเดือน -</option>
                          <?php
                          $months = array(
                                    "01"=>'January',
                                ...
                                foreach ($months as $key => $value) {
                          ?>
                          <option value="<?=$key?>" <?php if($_POST['month_cost_en'] == $key){ echo "selected";}?>><?=$value?></option>
                          <?php } ?>
                        </select>
                      </div>
                      </div>
            ...
            <div class="panel panel-default date_cost_panel" style="background-color: #eceff1;">
              <div class="panel-body">
                <div class="row date_cost">
                      ...
                      <div class="input-group date" id="datetimepicker" onchange="set_date_select();">
                        ...
                        if($_POST['date_start'] != ""){
                          if($_POST['year_set_1'] == "1"){
                            ...
                            $date_start = $date_ex[0]."/".$date_ex[1]."/".$date_ex[2];
                          }else {
              ...
              <div class="panel panel-default" style="background-color: #eceff1;">
                <div class="panel-body">
                  <div class="row div_report">
                    <div class="col-md-3">มูลค่าความเสียหาย</div>
                    <div class="col-md-1">ตั้งแต่</div>
                    <div class="col-md-3">
                    <input type="number" class="form-control" name="damage_start" value="<?=$_POST['damage_start']?>">
                    </div>
                    <div class="col-md-1" style="text-align:center;">ถึง</div>
                    <div class="col-md-3">
                      <input type="number" class="form-control" name="damage_end" value="<?=$_POST['damage_end']?>">
                    </div>
                    <div class="col-md-1"></div>
                  </div>
                  <div class="row div_report">
                    <div class="col-md-4">หน่วย</div>
                    <div class="col-md-2">
                      <select class="selectpicker form-control" name="Currency">
                        <?php
                        $sql = "SELECT * FROM `Currency`";
                        $query = $conn->query($sql);
                        while ($rx = $query->fetch_assoc()) {
                        ?>
                        <option value="<?=$rx['curren_id']?>" <?php if($_POST['Currency'] == $rx['curren_id']){ echo "selected";}?>><?=$rx['curren_name'];?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
            ...
            <div class="btn-report-issue">
              <button type="button" class="btn btn-success submit_report_cost_modal">ตกลง</button>
...
$(document).ready(function() {
  $('.table-caseCh-list').on('load-success.bs.table', function (e, name, args) {
    ...
    if($('.year_set_1').val() == "1"){
      if($('.cost_year_th').val() == ""){
        $('#cost_year1').attr('disabled', true);
      }else {
        $('#cost_year1').attr('disabled', false);
      }
      select_quarter_modal($('.quarter').val(),$('.month_cost_th').val());

      var month = $('.month_cost_th').val();

        $('#month_cost_1 option[value="'+month+'"]').attr("selected","selected");
        $('.selectpicker').selectpicker('refresh');
    }else {

      if($('.cost_year_en').val() == ""){
        $('#cost_year2').attr('disabled', true);
      }else {
        $('#cost_year2').attr('disabled', false);
      }
      select_quarter_modal($('.quarter').val());

      var month = $('.month_cost_en').val();
      $('#month_cost_2 option[value="'+month+'"]').attr("selected","selected");
      $('.selectpicker').selectpicker('refresh');
    }
...
function searchQueryParams(params) {
  ...
  params.cost_year_th = $("input[name='cost_year_th']").val();
  params.cost_year_en = $("input[name='cost_year_en']").val();
  params.quarter = $("input[name='quarter']").val();
  params.month_cost_th = $("input[name='month_cost_th']").val();
  params.month_cost_en = $("input[name='month_cost_en']").val();
  ...
  params.damage_start = $("input[name='damage_start']").val();
  params.damage_end = $("input[name='damage_end']").val();
  params.Currency = $("input[name='Currency']").val();
  params.office_id = $("input[name='office_id']").val();

  return params; // body data
}

function num_rows_cost(){
  var text = $("input[name='search_text']").val();
  var year_set_1 = $("input[name='year_set_1']").val();
  var year_set_2 = $("input[name='year_set_2']").val();
  var cost_year_th = $("input[name='cost_year_th']").val();
  var cost_year_en = $("input[name='cost_year_en']").val();
  var quarter = $("input[name='quarter']").val();
  var month_cost_th = $("input[name='month_cost_th']").val();
  var month_cost_en = $("input[name='month_cost_en']").val();
  ...
  var damage_start = $("input[name='damage_start']").val();
  var damage_end = $("input[name='damage_end']").val();
  var Currency = $("input[name='Currency']").val();
  var office_id = $("input[name='office_id']").val();

  $.ajax({
      url: 'report/num_rows_report_cost.php',
      type: 'POST',
      async: false,
      responseType: "json",
      data: {
        ...
        'cost_year_th':cost_year_th,
        'cost_year_en':cost_year_en,
        'quarter':quarter,
        'month_cost_th':month_cost_th,
        'month_cost_en':month_cost_en,
    ...
    success: function(res) {
      $('.total-case-cost').text(res.total);

      $('.total-waiting-cost').text("Waiting "+res.waiting+",");
      $('.total-new-cost').text("New "+res.new+",");
      $('.total-pending-cost').text("In Process "+res.pending+",");
      $('.total-overduemain-cost').text("Overdue Main Process "+res.overduemain+",");
      $('.total-overduesub-cost').text("Overdue Sub Process "+res.overduesub+",");
      $('.total-closesuccess-cost').text("Close Success "+res.closesuccess+",");
      $('.total-closecontinue-cost').text("Close Continue "+res.closecontinue+",");
      $('.total-close-cost').text("Close "+res.close);
      $('.total-closereject-cost').text("Close Reject "+res.closereject+",");

      $('.export-case-cost').val(res.total);

      $('.export-waiting-cost').val("Waiting "+res.waiting+",");
      $('.export-new-cost').val("New "+res.new+",");
      $('.export-pending-cost').val("In Process "+res.pending+",");
      $('.export-overduemain-cost').val("Overdue Main Process "+res.overduemain+",");
      $('.export-overduesub-cost').val("Overdue Sub Process "+res.overduesub+",");
      $('.export-closesuccess-cost').val("Close Success "+res.closesuccess+",");
      $('.export-closecontinue-cost').val("Close Continue "+res.closecontinue+",");
      $('.export-close-cost').val("Close "+res.close);
      $('.export-closereject-cost').val("Close Reject "+res.closereject+",");
...
function modal_chk_cost(){
  $('#modal_chk_cost').modal('show');
}
...
function chk_select_year(){
  var chk_radio = $('input[name=year_set_1]:checked', '#modal_filter_cost').val();
    ...
    if(set_year == ""){
        ...
        $('#select_quarter_chk_cost').val('');
        $('#month_cost_1').val('');
        $('#month_cost_2').val('');
    }else {
      $('#select_quarter_chk_cost').attr('disabled', false);
      $('#month_cost_1').attr('disabled', false);
      $('#month_cost_2').attr('disabled', false);
...
$( "#cost_year1" ).change(function() {
  chk_select_year();
  $('.selectpicker').selectpicker('refresh');
});
$( "#cost_year2" ).change(function() {
  chk_select_year();
  $('.selectpicker').selectpicker('refresh');
});

function select_month_cost(){
var chk_radio = $('input[name=year_set_1]:checked', '#modal_filter_cost').val();
if(chk_radio == "1"){
  var lang = 'th';
  var th = true;
...
$( "#select_quarter_chk_cost" ).change(function() {
  select_month_cost();
});
...
function getStartDate() {
  ...
  var select_quarter = $('#select_quarter_chk_cost').val();
    if(chk_radio == "1"){
      var set_year = $('#cost_year1').val();
      var set_month = $('#month_cost_1').val();
    }else {
      var set_year = $('#cost_year2').val();
      var set_month = $('#month_cost_2').val();
    }
