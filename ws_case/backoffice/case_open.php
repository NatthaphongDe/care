...
<script type="text/javascript">
  ...
  $(function() {
    ...
    $(document).delegate(".applntOrg_trade_number", "keyup paste", function(e) {
      $(this).parents(".form-group").find(".check_dbd_logo").attr("src", "img/btn_check_dbd_0.png");
      $(this).parents(".form-group").find(".check_ditp_logo").attr("src", "img/btn_check_ditp_0.png");
