  ...
  <div class="row row_title">
    <div class="col-md-6 box_appeal_title">
      <a href="?page=product">
        ...
        $sql_select3 = "SELECT * FROM `Product_Type` WHERE `prodType_id` = '$prodType_ref_id4' AND `prodType_level` = 3 ORDER BY `prodType_ref_id` ASC";
        ...
        $sql_select2 = "SELECT * FROM `Product_Type` WHERE `prodType_id` = '$prodType_ref_id3' AND `prodType_level` = 2 ORDER BY `prodType_ref_id` ASC";
        ...
        ?>
        <span class="txt_pro" ><a href="?page=product_detail&id_product=<?=$prodType_ref_id2 ?>"><?= $title2 ?></a></span>
          >
        <span class="txt_pro" ><a href="?page=product_detail_lv3&id_product=<?=$prodType_ref_id3 ?>"><?= $title3 ?></a></span>
          >
        <span class="txt_pro" ><a href="?page=product_detail_lv4&id_product=<?=$prodType_ref_id4 ?>"><?= $title4 ?></a></span>
      </div>
    ...
    <div class="tabla_data">
      ...
      data-url="method.php?method=getproduct_detail_lv5"
        ...
        <div class="modal-body">
          <div class="row form-group">
            ...
            <div class="col-md-7">
              ...
              <input type="hidden" class="form-control" id="input_lv" name="input_lv" value="5">
...
<form method="POST" action="method.php?method=edit_product"  enctype="multipart/form-data" target="iframe-data"  >
  <div class="modal fade edit_product" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title title_view" id="exampleModalLabel">แก้ไขประเภทสินค้า (ไทย)</h4>
        </div>
        <div class="modal-body" id="view_date">
          <div class="row form-group">
            <div class="col-md-5">
              <label for="recipient-name" class="control-label" name="edit_name">ชื่อประเภทสินค้าย่อย<?=$rematk?></label>
            </div>
            <div class="col-md-7">
