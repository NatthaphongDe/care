...
<div class="box_appeal">
  <div class="row row_title">
    ...
    <div class="col-md-12 col-xs-12 col-lg-9 search box_s1">
      ...
      <a href="../../data/setting/template/Template_corporate_thai.xlsx">
  ...
  <div class="tabla_data">
    ...
    data-url="corporate/method.php?method=get_corporate_thai"
    ...
    <thead>
      ...
      <th data-field="prov" data-sortable="true"  data-align="left" class="th_user">
        จังหวัด
      </th>
      <th data-field="code" data-sortable="true"  data-align="left" class="th_user">
        รหัสไปรษณีย์
      </th>
      <th data-field="depart" data-sortable="true"  data-align="left" class="th_user">
        สมาชิกกรม
      </th>
...
<!--  add -->
<form method="POST" action="corporate/method.php?method=save_corporate_thai"  enctype="multipart/form-data" target="iframe-data"  >
  <div class="modal fade modal_add_inter" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="exampleModalLabel">เพิ่มนิติบุคคลในประเทศไทย</h4>
        </div>
        ...
        <!-- <div class="box_gp_app"> -->
          ...
          <div class="row form_group_10">
              <div class="col-md-4">
                <label for="message-text" class="control-label body_txt_modal_16">ชื่อบริษัทที่จดทะเบียน<label class="txt_no_del" for="">*</label></label>
              </div>
              <div class="col-md-8 ct_card">
          ...
          <div class="row form_group_10">
              <div class="col-md-4">
                <label for="message-text" class="control-label body_txt_modal_16">ชื่อผู้ติดต่อ<label class="txt_no_del" for=""></label></label>
              </div>
              <div class="col-md-4">
                <input type="text" class="form-control body_txt_modal_add" name="contactfname" id="" value="">
              </div>
          </div>
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-4">
                <input type="text" class="form-control body_txt_modal_add" name="telephone" value="">
              </div>
          </div>
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-4">
                <input type="text" class="form-control body_txt_modal_add" name="web" value="">
              </div>
          </div>
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-8 select_selectpicker">
                <select class="selectpicker col-xs-2 chosen-select-dissearch" name="prov"  id="" data-width="200px" data-live-search="true">
          ...
          <div class="row form_group_10">
              <div class="col-md-4">
                <label for="message-text" class="control-label body_txt_modal_16">รหัสไปรษณีย์<label class="txt_no_del"></label></label>
              </div>
              <div class="col-md-4">
                <input type="text" class="form-control body_txt_modal_add input-mask" id="" name="zipcode" value=""  data-inputmask="'mask':'99999'" >
              </div>
          </div>

          <div class="row form_group_10">
              <div class="col-md-4">
                <label for="message-text" class="control-label body_txt_modal_16">สมาชิกกรม<label class="txt_no_del" for="">*</label></label>
              </div>
              <div class="col-md-8">
                <div class="col-md-6">
                  <div class="radio radio-danger ">
                    <input type="radio" name="department" id="radio3" value="1" checked="">
                ...
                <div class="col-md-6">
                  <div class="radio radio-danger ">
                    <input type="radio" name="department" id="radio4" value="2">
...
<!--  add -->
<form method="POST" action="corporate/method.php?method=save_corporate_thai"  enctype="multipart/form-data" target="iframe-data"  >
  <div class="modal fade edit_corporate_thai" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="exampleModalLabel">แก้ไขนิติบุคคลในประเทศไทย</h4>
        </div>
        ...
        <!-- <div class="box_gp_app"> -->
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-8 ct_card">
                <input type="text" class="form-control body_txt_modal_add input-mask" name="companyname" id="companyname" value="" >
              </div>
          </div>
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-4">
                <input type="text" class="form-control body_txt_modal_add" name="contactfname" id="contactfname" value="">
              </div>
          </div>
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-4">
                <input type="text" class="form-control body_txt_modal_add" name="web" id="web" value="" onkeyup="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลขเท่านั้น'); this.value='';}">
              </div>
          </div>
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-8 select_selectpicker">
                <select class="selectpicker col-xs-2 chosen-select-dissearch" name="prov"  id="prov" data-width="200px" data-live-search="true">
                  <option value="">--- เลือกจังหวัด ---</option>
                  <?php
                  $sql_select = "SELECT * FROM Province ";
                    $query_select = $conn->query($sql_select);
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-4">
                <input type="text" class="form-control body_txt_modal_add input-mask" id="zipcode" name="zipcode" value=""  data-inputmask="'mask':'99999'" >
              </div>
          </div>
          ...
          <div class="row form_group_10">
              ...
              <div class="col-md-8">
                <div class="col-md-6">
                  <div class="radio radio-danger ">
                    <input type="radio" name="department" id="radio3_edit" value="1" checked="">
                ...
                <div class="col-md-6">
                  <div class="radio radio-danger ">
                    <input type="radio" name="department" id="radio4_edit" value="2">
...
<form method="POST" action="corporate/method.php?method=import_corporate_thai"  enctype="multipart/form-data" target="iframe-data"  >
