    ...
    <div class="col-md-12 panel-body-bg2 no-gutter">
      ...
      <div class="form-group-inner no-gutter " id="form_group_company_'.$formSetId.'" '.($rs_case["case"]["applnt_type"]==0?'style="display:none"':'').'>
        ...
        <div class="form-group col-md-12">
          ...
          <div class="col-sm-6">
            <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'dbd\',\'#applntOrg_trade_number_IdxFs_'.$formSetId.'\',\'complnt\');"><img class="check_dbd_logo" id="check_dbd_logo_IdxFs_'.$formSetId.'" src="img/btn_check_dbd_'.($rs_case["case_feild"]["applnt_valid_dbd"]!=""?$rs_case["case_feild"]["applnt_valid_dbd"]:"0").'.png" /></button>
            <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'ditp\',\'#applntOrg_trade_number_IdxFs_'.$formSetId.'\',\'complnt\');"><img class="check_ditp_logo" id="check_ditp_logo_IdxFs_'.$formSetId.'" src="img/btn_check_ditp_'.($rs_case["case_feild"]["applnt_valid_ditp"]!=""?$rs_case["case_feild"]["applnt_valid_ditp"]:"0").'.png" /></button>
  ...
  $formSet_html = '<div class="panel-body">
    ...
    if($rs_case["case_feild"]["applnt_type"]!=0){
      ...
      <div class="form-group col-sm-10 line-top-border">
        ...
        '.($rs_case["case_feild"]["applnt_valid_ditp"]!=""?'<img class="ico_validate" src="img/ditp/icon_ditp_'.($rs_case["case_feild"]["applnt_valid_ditp_org"]!=""?$rs_case["case_feild"]["applnt_valid_ditp_org"]:$rs_case["case_feild"]["applnt_valid_ditp"]).'.png" />':'').'
      </div>
