...
WHERE m.member_id = '".$rs_case["case"]["case_createBy_id"]."'";
...
if($typeformset=="case_open"){
  ...
  //     <div class="col-sm-4">
  //       <input type="text" value="'.$rs_case["case_feild"]["applnt_ident"].'" class="form-control " name="applnt_ident_IdxFs_'.$formSetId.'" id="applnt_ident_IdxFs_'.$formSetId.'" placeholder="เลขบัตรประชาชน / Passport No."  />
  //     </div>
  //     <div class="col-sm-6">
  //     </div>
  //   </div>
  ...
  // else {
    ...
    <div class="form-group col-md-12">
      ...
      <label class="col-sm-2 control-label control-label-r">คำนำหน้าชื่อ</label>
      <div class="col-sm-4">
        <select class="custom-select" name="applnt_title_IdxFs_'.$formSetId.'">
          <option value="" >
            --- เลือกคำนำหน้าชื่อ ---
  ...
  // else if (in_array($_SESSION['admin']['empId'], array('1', '7'))) {
    ...
    <div class="form-group col-md-12">
      ...
      <!-- applnt_mobile_IdxFs_{form_id} -->
      <label class="col-sm-2 control-label control-label-r required">เบอร์โทรศัพท์มือถือ</label>
      <div class="col-sm-4 flex-container">
        <div class="flex2" id="tel1">
          <input type="text" value="'.($rs_case["case_feild"]["applnt_tel"]!=""?$rs_case["case_feild"]["applnt_tel"]:$rs_case["case_feild"]["applnt_mobile"]).'" data-code="'.$rs_case["case_feild"]["applnt_mobile_country"].'"  class="form-control input-mask phone-number-info" name="applnt_mobile_IdxFs_'.$formSetId.'" data-inputmask="&apos;mask&apos;:&apos;999-999-9999&apos;" />
  ...
  //   echo '$rs_case["case"]["applnt_type"].: '.$rs_case["case"]["applnt_type"];
  // }
  $formSet_html .= '
    <div class="form-group col-md-12">
    ...
    <div class="form-group col-md-12">
      ...
      <div class="col-sm-4">
          <select name="applnt_country_id_IdxFs_'.$formSetId.'" class="form-control select-picker" data-live-search="true">
      ...
      <div class="col-sm-4">
        <input type="text" value="'.$rs_case["case_feild"]["applnt_zipcode"].'" class="form-control " name="applnt_zipcode_IdxFs_'.$formSetId.'"   />
      </div>
    </div>
  </div>
    ...
    <div class="col-md-12 panel-body-bg2 no-gutter">
      ...
      <div class="form-group-inner no-gutter " id="form_group_company_'.$formSetId.'" '.(( empty($rs_case["case"]["applnt_type"]) || $rs_case["case"]["applnt_type"] != 1 )?'style="display:none"':'').'>
        ...
        <div class="form-group col-md-12">
          ...
          <div class="col-sm-4">
            <input type="text" value="'.$rs_case["case_feild"]["applntOrg_trade_number"].'" class="form-control" name="applntOrg_trade_number_IdxFs_'.$formSetId.'" id="applntOrg_trade_number_IdxFs_'.$formSetId.'" " />
          </div>';
  // if (in_array($_SESSION['admin']['empId'], array('1', '7')) && $this->compTypeSub1 === '2') {
  if ($this->compTypeSub1 === '2') {
  $formSet_html .= '
          <div class="col-sm-6">
          <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'dbd\',\'#form_group_company_'.$formSetId.' #applntOrg_trade_number_IdxFs_'.$formSetId.'\',\'applnt\');"><img class="check_dbd_logo" id="check_dbd_logo_IdxFs_'.$formSetId.'" src="img/btn_check_dbd_'.($rs_case["case_feild"]["applnt_valid_dbd"]!=""?$rs_case["case_feild"]["applnt_valid_dbd"]:"0").'.png" /></button>
          <button class="btn btn-default btn-image" type="button" onclick="case_open.checkWebService(\'ditp\',\'#form_group_company_'.$formSetId.' #applntOrg_trade_number_IdxFs_'.$formSetId.'\',\'applnt\');"><img class="check_ditp_logo" id="check_ditp_logo_IdxFs_'.$formSetId.'" src="'.($rs_case["case_feild"]["applnt_valid_ditp"]!=""?($rs_case["case_feild"]["applnt_valid_ditp"]=="1"?"img/ditp/btn-ditp-".$rs_case["case_feild"]["applnt_valid_ditp_org"]:"img/btn_check_ditp_".$rs_case["case_feild"]["applnt_valid_ditp"]):"img/btn_check_ditp_0").'.png" /></button>
  ...
  $formSet_html .= '
        ...
        <div class="form-group col-md-12">
          ...
          <div class="col-sm-4 flex-container">
            <div class="flex2" id="tel2">
              <input type="text" value="'.$rs_case["case_feild"]["applntOrg_tel"].'" data-code="'.$rs_case["case_feild"]["applntOrg_mobile_country"].'"  class="form-control input-mask phone-number" name="applntOrg_tel_IdxFs_'.$formSetId.'" data-inputmask="&apos;mask&apos;:&apos;999-999-9999&apos;" />
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-2 control-label required">ประเทศ</label>
          <div class="col-sm-4">
              <select name="applntOrg_country_id_IdxFs_'.$formSetId.'" class="form-control select-picker" data-live-search="true">
                <option value="" style="color:#777">
                 --- เลือกประเทศ ---
                </option>
                '.$countryList_applnt.'
          ...
          <label class="col-sm-2 control-label control-label-r ">รหัสไปรษณีย์</label>
          <div class="col-sm-4">
            <input type="text" value="'.$rs_case["case_feild"]["applntOrg_zipcode"].'" class="form-control " name="applntOrg_zipcode_IdxFs_'.$formSetId.'"   />
          </div>
        </div>
  ...
  if($rs_case["case_feild"]["applnt_country_id"] == '162') {
  ...
  $formSet_html = '<div class="panel-body">
    ...
    <div id="collapse1" class="collapse in"  aria-labelledby="headingOne">
      ...
      <div class="form-group col-md-12">
        <label class="col-sm-4 control-label">เลขบัตรประชาชน / Passport No.</label>
        <div class="col-sm-8">
      ...
      if($rs_case["case_feild"]["applnt_type"] == 1){
        if($rs_case["case_feild"]["applntOrg_country_id"] == '162') {
        ...
        <div class="form-group col-sm-10 line-top-border">
          ...
          '.($rs_case["case_feild"]["applnt_valid_ditp"]!=""?'<img class="ico_validate" src="img/ditp/icon_ditp_'.($rs_case["case_feild"]["applnt_valid_ditp"]!="2"?$rs_case["case_feild"]["applnt_valid_ditp_org"]:($rs_case["case_feild"]["applnt_valid_ditp_org"]=="non member"?"non-member":$rs_case["case_feild"]["applnt_valid_ditp"])).'.png" />':'').'
        </div>
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-4 control-label">ประเทศ</label>
          <div class="col-sm-8">
            <label class="text-data text-data-green">'.($rs_case["case_feild"]["applntOrg_country_id"]!=""?$countryList[$rs_case["case_feild"]["applntOrg_country_id"]]:"-").'</label>
          </div>
        </div>
    ...
    // else if (in_array($_SESSION['admin']['empId'], array('1', '7')) && $rs_case["case_feild"]["applnt_type"] == 2) {
    // if ($rs_case["case_feild"]["applnt_type"] == 2) {
    //   $formSet_html .= '<!-- ยื่นในนามบุคคลธรรมดา -->
    //   <div class="form-group col-sm-10 line-top-border">
    //     <span class="glyph-icon icon-user" aria-hidden="true"></span>
    //     <label class="text-data">'.($rs_case["case_feild"]["applntOrg_name"]!=""?$rs_case["case_feild"]["applntOrg_name"]:"ยื่นในนามบุคคลธรรมดา").'</label>
    //     '.($rs_case["case_feild"]["applnt_valid_dbd"]!=""?'<img class="ico_validate" src="img/icon_dbd_'.$rs_case["case_feild"]["applnt_valid_dbd"].'.png" />':'').'
    //     '.($rs_case["case_feild"]["applnt_valid_ditp"]!=""?'<img class="ico_validate" src="img/icon_ditp_'.$rs_case["case_feild"]["applnt_valid_ditp"].'.png" />':'').'
    //   </div>
    //   <div class="form-group col-sm-2 line-top-border">
  ...
  $formSet_html = '<div class="panel-body">
    ...
    <div id="collapse1" class="collapse in"  aria-labelledby="headingOne">
      ...
      <div class="form-group col-md-12">
        <label class="col-sm-4 control-label">อาชีพ</label>
        <div class="col-sm-8">
          <label class="text-data text-data-green">'.($rs_case["case_feild"]["applnt_career"]!=""?$rs_case["case_feild"]["applnt_career"]:$re['member_occupation']).'</label>
        </div>
      </div>
      -->
      ...
      <div class="form-group col-md-12">
        <label class="col-sm-4 control-label">ไปรษณีย์</label>
        <div class="col-sm-8">
          <label class="text-data text-data-green">'.($re['member_postcode']!=""?$re['member_postcode']:$rs_case["case_feild"]["applnt_zipcode"]).'</label>
        </div>
      </div>
      ...
      <div class="form-group col-md-12">
        <label class="col-sm-4 control-label">ประเทศ</label>
        <div class="col-sm-8">
          <label class="text-data text-data-green">'.($rs_case["case_feild"]["applnt_country_id"]!=""?$countryList[$rs_case["case_feild"]["applnt_country_id"]]:$country_name[0]['name']).'</label>
        </div>
      </div>';
    ...
    // else if (in_array($_SESSION['admin']['empId'], array('1', '7')) && $rs_case["case_feild"]["applnt_type"] == 2) {
      ...
      if($re['member_type'] == 1){
        ...
        <div class="form-group col-sm-10 line-top-border">
          <span class="glyph-icon icon-building-o" aria-hidden="true"></span>
          <label class="text-data">'.($re['member_comp_name']!=""?$re['member_comp_name']:"-").'</label>
          '.($rs_case["case_feild"]["applnt_valid_dbd"]!=""?'<img class="ico_validate" src="img/icon_dbd_'.$rs_case["case_feild"]["applnt_valid_dbd"].'.png" />':'').'
          '.($rs_case["case_feild"]["applnt_valid_ditp"]!=""?'<img class="ico_validate" src="img/icon_ditp_'.$rs_case["case_feild"]["applnt_valid_ditp"].'.png" />':'').'
        </div>
        <div class="form-group col-sm-2 line-top-border">
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-4 control-label">เลขนิติบุคคล</label>
          <div class="col-sm-8">
            <label class="text-data text-data-green">'.($re['member_comp_taxid']!=""?$re['member_comp_taxid']:"-").'</label>
          </div>
        </div>
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-4 control-label">สาขา</label>
          <div class="col-sm-8">
            <label class="text-data text-data-green">'.($re['member_comp_branch']!=""?$re['member_comp_branch']:"-").'</label>
          </div>
        </div>
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-4 control-label">เบอร์โทรศัพท์</label>
          <div class="col-sm-8">
            <label class="text-data text-data-green">'.($re['member_comp_phone']!=""?$re['member_comp_phone']:"-").'</label>
          </div>
        </div>
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-4 control-label">เว็บไซต์</label>
          <div class="col-sm-8">
            <label class="text-data text-data-green">'.($re['member_comp_web']!=""?$re['member_comp_web']:"-").'</label>
          </div>
        </div>
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-4 control-label">ที่อยู่ติดต่อ</label>
          <div class="col-sm-8">
            <label class="text-data text-data-green">'.($re['member_comp_address']!=""?$re['member_comp_address']:"-").'</label>
          </div>
        </div>
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-4 control-label">ไปรษณีย์</label>
          <div class="col-sm-8">
            <label class="text-data text-data-green">'.($re['member_comp_postcode']!=""?$re['member_comp_postcode']:"-").'</label>
          </div>
        </div>
        <!-- /เป็นตัวแทนบริษัท -->
        ';
