    ...
    <div class="col-md-12 panel-body-bg2 no-gutter">
      ...
      <div class="form-group-inner no-gutter " id="form_group_company_'.$formSetId.'" '.(( empty($rs_case["case"]["applnt_type"]) || $rs_case["case"]["applnt_type"] != 1 )?'style="display:none"':'').'>
        ...
        <div class="form-group col-md-12">
          <label class="col-sm-2 control-label required">ประเทศ</label>
          <div class="col-sm-4">
              <select name="applntOrg_country_id_IdxFs_'.$formSetId.'" class="select-picker" data-live-search="true">
                <option value="" style="color:#777">
                 --- เลือกประเทศ ---
                </option>
  ...
  $formSet_html = '<div class="panel-body">
    ...
    <div id="collapse1" class="collapse in"  aria-labelledby="headingOne">
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-8">
          <label class="text-data text-data-green">'.($rs_case["case_feild"]["applnt_tel"]!=""?($rs_case["case_feild"]["applnt_mobile_code"].substr($rs_case["case_feild"]["applnt_tel"],1)):($rs_case["case_feild"]["applnt_mobile_code"].substr($rs_case["case_feild"]["applnt_mobile"],1))).'</label>
        </div>
      </div>
      ...
      // if (in_array($_SESSION['admin']['empId'], array('1', '7'))) {
      //   var_dump($rs_case["case_feild"]);
      // }
      if($rs_case["case_feild"]["applnt_type"]==1){
      $formSet_html .= '<!-- เป็นตัวแทนบริษัท1 -->
      <div class="form-group col-sm-10 line-top-border">
        ...
        '.($rs_case["case_feild"]["applnt_valid_ditp"]!=""?'<img class="ico_validate" src="img/ditp/icon_ditp_'.$rs_case["case_feild"]["applnt_valid_ditp"].'.png" />':'').'
      </div>
      ...
      <div class="form-group col-md-12">
        ...
        <div class="col-sm-8">
          <label class="text-data text-data-green">'.($rs_case["case_feild"]["applntOrg_tel"]!=""?($rs_case["case_feild"]["applntOrg_mobile_code"].substr($rs_case["case_feild"]["applntOrg_tel"],1)):"-").'</label>
        </div>
      </div>
